...
- The corridor provides a 20% player maximum-speed slipstream and a 10% thrust improvement. Four visible boost patches temporarily increase the lane-adjusted maximum speed by another 50% and thrust by 75%. A low continuous perpendicular maintenance pressure nudges debris outward and slowly relocates its spring anchor beyond the road edge, allowing naturally displaced and encounter-generated rocks to clear without being launched.
