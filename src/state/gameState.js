import { createEventLedger } from "../systems/eventLedger.js?v=fresh-20260909-2149-9b7cd4cb";
import { PANEL_IDS } from "../systems/componentRegistry.js?v=fresh-20260909-2149-9b7cd4cb";
import { createInitialAccounts } from "../systems/accounts.js?v=fresh-20260909-2149-9b7cd4cb";
import { createInitialHulls } from "../systems/hulls.js?v=fresh-20260909-2149-9b7cd4cb";
import { createInitialObligations } from "../systems/obligations.js?v=fresh-20260909-2149-9b7cd4cb";
import { seedAuthorityFoundation } from "../systems/authoritySeeds.js?v=fresh-20260909-2149-9b7cd4cb";
import { createEmptyWorldRecords } from "../systems/worldRecords.js?v=fresh-20260909-2149-9b7cd4cb";
import { createInitialSprcState } from "../systems/sprcOperation.js?v=fresh-20260909-2149-9b7cd4cb";
import { createInitialLogisticsState } from "../systems/logistics.js?v=fresh-20260909-2149-9b7cd4cb";
import { createInitialPopulationState } from "../systems/populationDemand.js?v=fresh-20260909-2149-9b7cd4cb";
import { createInitialProcurementState } from "../systems/hubProcurement.js?v=fresh-20260909-2149-9b7cd4cb";
import { createInitialTowServiceState } from "../systems/towService.js?v=fresh-20260909-2149-9b7cd4cb";
import { createInitialRightsAuthorities } from "../systems/rightsAuthority.js?v=fresh-20260909-2149-9b7cd4cb";
import { createInitialIndustrialState } from "../systems/industrialProduction.js?v=fresh-20260909-2149-9b7cd4cb";
import { consolidateSprcOwnership } from "../systems/sprcOwnership.js?v=fresh-20260909-2149-9b7cd4cb";
import { createInitialNpcDevelopmentState } from "../systems/npcDevelopment.js?v=fresh-20260909-2149-9b7cd4cb";
import { createInitialWorldNetwork } from "../systems/worldNetworkRegistry.js?v=fresh-20260909-2149-9b7cd4cb";
import { createCockpitLayoutState } from "../systems/cockpitLayout.js?v=fresh-20260909-2149-9b7cd4cb";
