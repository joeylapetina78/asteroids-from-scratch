import { getRightTypeForAction, isRecordActive, limitsAllowAction } from "./authorityModel.js?v=fresh-20260726-1139-3d379b8";
import { actorHasPower, getAuthorityGrant } from "./authorityRegistry.js?v=fresh-20260726-1139-3d379b8";
import { isSameOrChildPlace } from "./placeRegistry.js?v=fresh-20260726-1139-3d379b8";
import { getWorldDocument } from "./worldRecords.js?v=fresh-20260726-1139-3d379b8";
