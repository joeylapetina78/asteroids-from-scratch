...
import { evaluateSupplierAsk, getSpendable } from "./valuation.js?v=fresh-20260916-2002-07db9a05";
import { DIAGNOSTIC_STATE, recordDiagnostic } from "./diagnostics.js?v=fresh-20260916-2002-07db9a05";
import { applyCraftUse, ensureCraftComponents, getWorstComponent, serviceCraftComponent } from "./componentCondition.js?v=fresh-20260916-2002-07db9a05";
