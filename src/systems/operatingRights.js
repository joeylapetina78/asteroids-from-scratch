...
import { RIGHT_TYPES } from "./authorityModel.js?v=fresh-20260909-1841-3b03c045";
import { evaluateTerritoryAccess } from "./hubTerritories.js?v=fresh-20260909-1841-3b03c045";
