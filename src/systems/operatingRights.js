...
import { RIGHT_TYPES } from "./authorityModel.js?v=fresh-20260918-2012-165f50cd";
import { evaluateTerritoryAccess } from "./hubTerritories.js?v=fresh-20260918-2012-165f50cd";
