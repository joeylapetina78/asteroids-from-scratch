...
import { RIGHT_TYPES } from "./authorityModel.js?v=fresh-20260822-1226-8a8ff3f3";
import { evaluateTerritoryAccess } from "./hubTerritories.js?v=fresh-20260822-1226-8a8ff3f3";
