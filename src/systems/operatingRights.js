...
import { RIGHT_TYPES } from "./authorityModel.js?v=fresh-20260917-1715-cca5018f";
import { evaluateTerritoryAccess } from "./hubTerritories.js?v=fresh-20260917-1715-cca5018f";
