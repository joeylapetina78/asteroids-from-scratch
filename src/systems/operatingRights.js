...
import { RIGHT_TYPES } from "./authorityModel.js?v=fresh-20260822-1344-layout";
import { evaluateTerritoryAccess } from "./hubTerritories.js?v=fresh-20260822-1344-layout";
