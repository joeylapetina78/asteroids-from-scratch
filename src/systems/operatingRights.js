...
import { RIGHT_TYPES } from "./authorityModel.js?v=fresh-20260916-2002-07db9a05";
import { evaluateTerritoryAccess } from "./hubTerritories.js?v=fresh-20260916-2002-07db9a05";
