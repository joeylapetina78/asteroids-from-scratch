...
import { RIGHT_TYPES } from "./authorityModel.js?v=fresh-20260916-2047-f04aec86";
import { evaluateTerritoryAccess } from "./hubTerritories.js?v=fresh-20260916-2047-f04aec86";
