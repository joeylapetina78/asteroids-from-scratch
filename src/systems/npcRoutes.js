import { NpcShip } from "../entities/NpcShip.js?v=fresh-20260910-1723-7b622d5f";
import { FIRST_REACH_CARRIERS } from "../content/transportation/firstReachCarriers.js?v=fresh-20260910-1723-7b622d5f";
