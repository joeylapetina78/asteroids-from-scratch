import { NpcShip } from "../entities/NpcShip.js?v=fresh-20260918-1918-133a739f";
import { FIRST_REACH_CARRIERS } from "../content/transportation/firstReachCarriers.js?v=fresh-20260918-1918-133a739f";
