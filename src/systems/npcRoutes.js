import { NpcShip } from "../entities/NpcShip.js?v=fresh-20260820-0654-6716a5f";
import { FIRST_REACH_CARRIERS } from "../content/transportation/firstReachCarriers.js?v=fresh-20260820-0654-6716a5f";
