import { NpcShip } from "../entities/NpcShip.js?v=fresh-20260810-1926-e4ff78f";
import { FIRST_REACH_CARRIERS } from "../content/transportation/firstReachCarriers.js?v=fresh-20260810-1926-e4ff78f";
