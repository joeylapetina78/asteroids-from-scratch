import { drawResourceShape } from "../entities/ResourcePickup.js?v=resource-visibility-v1";
import { RESOURCE_COLOR, getResourceShape } from "./resourceDefinitions.js?v=resource-families-v1";
