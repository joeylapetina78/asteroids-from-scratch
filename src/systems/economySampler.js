...
import { getEffectiveMaterialUnits, getResourceEffectiveYield, getResourceFamily } from "./resourceDefinitions.js?v=fresh-20260820-1818-9a1a051";
import { TRADED_FAMILIES, getInventoryPosition } from "./hubInventory.js?v=fresh-20260820-1818-9a1a051";
import { STANDING_MINING_ORDERS } from "./miningOperation.js?v=fresh-20260820-1818-9a1a051";
import { getSupplierAskPrice, listSettlementIds } from "./hubProcurement.js?v=fresh-20260820-1818-9a1a051";
import { getActorFinances, getArchetypeId } from "./actorConfig.js?v=fresh-20260820-1818-9a1a051";
import { listActors } from "./actorRegistry.js?v=fresh-20260820-1818-9a1a051";
import { POPULATION_NEEDS } from "./populationDemand.js?v=fresh-20260820-1818-9a1a051";
