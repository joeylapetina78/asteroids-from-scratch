import { getOreClusterSeedsInRadius } from "./asteroidField.js?v=fresh-20260726-1149-12a9b04";
import { getResourceDefinition, getResourceFamily } from "./resourceDefinitions.js?v=fresh-20260726-1149-12a9b04";
import { getRegionProfile } from "./worldRegions.js?v=fresh-20260726-1149-12a9b04";
import { getZoneProfile } from "./worldZones.js?v=fresh-20260726-1149-12a9b04";
