...
import { getActorRecord } from "./actorRegistry.js?v=fresh-20260820-1818-9a1a051";
import { getActorCapabilityPortfolio, getActorCapabilities as getPortfolioCapabilities } from "./assetCapabilities.js?v=fresh-20260820-1818-9a1a051";
