...
import { getActorRecord } from "./actorRegistry.js?v=fresh-20260822-1344-layout";
import { getActorCapabilityPortfolio, getActorCapabilities as getPortfolioCapabilities } from "./assetCapabilities.js?v=fresh-20260822-1344-layout";
