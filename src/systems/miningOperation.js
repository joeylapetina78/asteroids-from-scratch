import { MiningWorkerShip } from "../entities/MiningWorkerShip.js?v=fresh-20260820-2136-3d2a51a";
import { getOreClusterSeedsInRadius } from "./asteroidField.js?v=fresh-20260820-2136-3d2a51a";
import { getInstitutionalFeedstockTradeValue, getResourceFamily } from "./resourceDefinitions.js?v=fresh-20260820-2136-3d2a51a";
import { canActorDoAction } from "./ruleChecker.js?v=fresh-20260820-2136-3d2a51a";
import { getMiningWorkWear } from "./wearRates.js?v=fresh-20260820-2136-3d2a51a";
import { evaluateMiningJob, evaluateProcurement, urgencyFromCoverage } from "./valuation.js?v=fresh-20260820-2136-3d2a51a";
import { getInventoryPosition, sellMaterialToHub } from "./hubInventory.js?v=fresh-20260820-2136-3d2a51a";
import { getServiceCost, recordAcquisition, recordServiceCost } from "./costBasis.js?v=fresh-20260820-2136-3d2a51a";
import { getActorProtectedCash, getActorTraits } from "./actorConfig.js?v=fresh-20260820-2136-3d2a51a";
import { FLEET_CAPACITY_DEFAULTS, createCommissionCapability, createHireCapability, createReleaseCapability, planFleetCapacity, resolveFleetPolicy } from "./fleetCapacity.js?v=fresh-20260820-2136-3d2a51a";
import { createWithdrawForServiceCapability, planCraftService, resolveServicePolicy } from "./serviceDecision.js?v=fresh-20260820-2136-3d2a51a";
import { createSurveyedDeposit, rankDepositCandidates, recordDepositObservation, rememberSurveyedDeposit, resolveProspectingPolicy } from "./depositKnowledge.js?v=fresh-20260820-2136-3d2a51a";
import { adaptMiningAllocation } from "./intentions.js?v=fresh-20260820-2136-3d2a51a";
import { createExtractionOffer, filterUncommittedOffers, listExtractionOffers, registerExtractionOfferSource } from "./extractionOffers.js?v=fresh-20260820-2136-3d2a51a";
import { clearExtractionMarket, getMarketOutbid, registerExtractionMarketParticipant } from "./extractionMarket.js?v=fresh-20260820-2136-3d2a51a";
import { BLOCKER_KIND, DIAGNOSTIC_STATE, clearBlocker, createBlocker, recordBlocker, recordDecision, recordDiagnostic, retireDiagnostic } from "./diagnostics.js?v=fresh-20260820-2136-3d2a51a";
import { settlementExtractionDefinitions } from "../content/economy/firstReachSettlements.js?v=fresh-20260820-2136-3d2a51a";
import { listGeneratedExtractionDefinitions } from "./settlementSeedPipeline.js?v=fresh-20260820-2136-3d2a51a";
import { isHubAggregated } from "./simulationMode.js?v=fresh-20260820-2136-3d2a51a";
import { CINDER_MINING_SEED } from "../content/economy/miningInstitutions.js?v=fresh-20260820-2136-3d2a51a";
import { recruitPopulationLabor } from "./populationLabor.js?v=fresh-20260820-2136-3d2a51a";
import { canOperateEquipment } from "./operatorSkills.js?v=fresh-20260820-2136-3d2a51a";
import { ENGINE_MODELS } from "../content/ships/engineModels.js?v=fresh-20260820-2136-3d2a51a";
import { createCommercialCraftPublicIdentity } from "./publicIdentity.js?v=fresh-20260820-2136-3d2a51a";
import { applyCraftUse, ensureCraftComponents, getWorstComponent, serviceCraftComponent } from "./componentCondition.js?v=fresh-20260820-2136-3d2a51a";
import { appendBoundedHistory } from "./boundedHistory.js?v=fresh-20260820-2136-3d2a51a";
import { ensureMiningOrderBook, getMiningOrderBook, getPostedMiningOrder, setMiningOrderBook } from "./miningOrderBook.js?v=fresh-20260820-2136-3d2a51a";
