...
import { PROCUREMENT_STATUS, hubName, listOrders } from "./hubProcurement.js?v=fresh-20260731-2325-7368fe3";
import { getPostedMiningOrders } from "./miningOperation.js?v=fresh-20260731-2325-7368fe3";
