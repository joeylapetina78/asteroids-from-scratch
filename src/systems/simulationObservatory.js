import { DETAIL, DETAIL_DEFAULTS, detailCadence, resolveDetailLevel, getRuntimeSimulationSites } from "./detailLevel.js?v=fresh-20260821-0638-453f3f93";
import { DISTANT_DEFAULTS } from "./distantSimulation.js?v=fresh-20260821-0638-453f3f93";
import { listHubIds } from "./hubActors.js?v=fresh-20260821-0638-453f3f93";
import { describeObservation, estimateFlowDrift } from "./regionFlow.js?v=fresh-20260821-0638-453f3f93";
import { getEconomySamples } from "./economySampler.js?v=fresh-20260821-0638-453f3f93";
import { ensureDistantSimulationState } from "./simulationMode.js?v=fresh-20260821-0638-453f3f93";
