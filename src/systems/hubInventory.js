...
import { getEffectiveMaterialUnits, getInstitutionalFeedstockTradeValue, getResourceFamily } from "./resourceDefinitions.js?v=fresh-20260815-0000-e62b7fb";
import { recordAcquisition } from "./costBasis.js?v=fresh-20260815-0000-e62b7fb";
import { NEED_KIND, POPULATION_NEEDS, POPULATION_PROFILES } from "./populationDemand.js?v=fresh-20260815-0000-e62b7fb";
import { INSTITUTION_MINING_RIGHTS } from "./authoritySeeds.js?v=fresh-20260815-0000-e62b7fb";
