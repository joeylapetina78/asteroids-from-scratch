...
import { INSTITUTION_MINING_RIGHTS } from "./authoritySeeds.js?v=fresh-20260802-1504-d6b41cd";
import { getBundleCost, getUnitCost, recordProduction } from "./costBasis.js?v=fresh-20260802-1504-d6b41cd";
...
import { settlementPopulationProfiles } from "../content/economy/firstReachSettlements.js?v=fresh-20260802-1504-d6b41cd";
