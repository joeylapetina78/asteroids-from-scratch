import { InvaderPortal } from "../entities/InvaderPortal.js?v=fresh-20260814-2140-75a5acd";
import { FlightFighter } from "../entities/FlightFighter.js?v=fresh-20260814-2140-75a5acd";
import { Lifeform } from "../entities/Lifeform.js?v=fresh-20260814-2140-75a5acd";
import { hashNumbers } from "./random.js?v=fresh-20260814-2140-75a5acd";
