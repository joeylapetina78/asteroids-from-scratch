import { InvaderPortal } from "../entities/InvaderPortal.js?v=fresh-20260813-1827-6f00c8e";
import { FlightFighter } from "../entities/FlightFighter.js?v=fresh-20260813-1827-6f00c8e";
import { Lifeform } from "../entities/Lifeform.js?v=fresh-20260813-1827-6f00c8e";
import { hashNumbers } from "./random.js?v=fresh-20260813-1827-6f00c8e";
