import { InvaderPortal } from "../entities/InvaderPortal.js?v=fresh-20260907-2048-950a7d80";
import { FlightFighter } from "../entities/FlightFighter.js?v=fresh-20260907-2048-950a7d80";
import { Lifeform } from "../entities/Lifeform.js?v=fresh-20260907-2048-950a7d80";
import { hashNumbers } from "./random.js?v=fresh-20260907-2048-950a7d80";
