import { InvaderPortal } from "../entities/InvaderPortal.js?v=fresh-20260811-2005-d6bdaee";
import { FlightFighter } from "../entities/FlightFighter.js?v=fresh-20260811-2005-d6bdaee";
import { Lifeform } from "../entities/Lifeform.js?v=fresh-20260811-2005-d6bdaee";
import { hashNumbers } from "./random.js?v=fresh-20260811-2005-d6bdaee";
