import { InvaderPortal } from "../entities/InvaderPortal.js?v=fresh-20260814-2016-6d4590b";
import { FlightFighter } from "../entities/FlightFighter.js?v=fresh-20260814-2016-6d4590b";
import { Lifeform } from "../entities/Lifeform.js?v=fresh-20260814-2016-6d4590b";
import { hashNumbers } from "./random.js?v=fresh-20260814-2016-6d4590b";
