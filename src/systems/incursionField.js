import { InvaderPortal } from "../entities/InvaderPortal.js?v=fresh-20260810-1926-e4ff78f";
import { FlightFighter } from "../entities/FlightFighter.js?v=fresh-20260810-1926-e4ff78f";
import { Lifeform } from "../entities/Lifeform.js?v=fresh-20260810-1926-e4ff78f";
import { hashNumbers } from "./random.js?v=fresh-20260810-1926-e4ff78f";
