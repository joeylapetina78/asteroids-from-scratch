import { GREATBLOOM_DEEP_RADIUS, Lifeform } from "../entities/Lifeform.js?v=fresh-20260910-2000-2fc8171c";
import { createRandom, hashNumbers, randomRange } from "./random.js?v=fresh-20260910-2000-2fc8171c";
import { pickRockmossStrain } from "./rockmossStrains.js?v=fresh-20260910-2000-2fc8171c";
