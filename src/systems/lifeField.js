import { GREATBLOOM_DEEP_RADIUS, Lifeform } from "../entities/Lifeform.js?v=fresh-20260916-1933-11cfe7e0";
import { createRandom, hashNumbers, randomRange } from "./random.js?v=fresh-20260916-1933-11cfe7e0";
import { pickRockmossStrain } from "./rockmossStrains.js?v=fresh-20260916-1933-11cfe7e0";
