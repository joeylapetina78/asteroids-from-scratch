import { GREATBLOOM_DEEP_RADIUS, Lifeform } from "../entities/Lifeform.js?v=fresh-20260916-2047-f04aec86";
import { createRandom, hashNumbers, randomRange } from "./random.js?v=fresh-20260916-2047-f04aec86";
import { pickRockmossStrain } from "./rockmossStrains.js?v=fresh-20260916-2047-f04aec86";
