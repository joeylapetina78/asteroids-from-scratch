import { PLACE_TYPES, POWER_TYPES, RIGHT_TYPES } from "./authorityModel.js?v=fresh-20260808-2152-9eba91f";
import { upsertAuthorityGrant } from "./authorityRegistry.js?v=fresh-20260808-2152-9eba91f";
import { ensureRegionPlace, upsertPlace } from "./placeRegistry.js?v=fresh-20260808-2152-9eba91f";
import { WORLD_REGIONS } from "./worldRegions.js?v=fresh-20260808-2152-9eba91f";
import { settlementMiningRights, settlementPlaces } from "../content/economy/firstReachSettlements.js?v=fresh-20260808-2152-9eba91f";
