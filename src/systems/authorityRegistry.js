import { getPowerTypeForAction, getRightTypeForAction, isRecordActive, limitsAllowAction } from "./authorityModel.js?v=fresh-20260820-1818-9a1a051";
import { isSameOrChildPlace } from "./placeRegistry.js?v=fresh-20260820-1818-9a1a051";
import { ensureWorldRecords } from "./worldRecords.js?v=fresh-20260820-1818-9a1a051";
