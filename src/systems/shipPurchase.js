import { getCurrentShipLegal, getPilotName, updateCurrentShipLegal } from "./legalRecords.js?v=fresh-20260916-2047-f04aec86";
import { canSpendCredits, getCredits, spendCredits } from "./accounts.js?v=fresh-20260916-2047-f04aec86";
import { registerHull, setActiveHull } from "./hulls.js?v=fresh-20260916-2047-f04aec86";
import {
...
} from "./worldRecords.js?v=fresh-20260916-2047-f04aec86";
