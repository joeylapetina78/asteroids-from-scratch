import { getCurrentShipLegal, getPilotName, updateCurrentShipLegal } from "./legalRecords.js?v=fresh-20260916-2002-07db9a05";
import { canSpendCredits, getCredits, spendCredits } from "./accounts.js?v=fresh-20260916-2002-07db9a05";
import { registerHull, setActiveHull } from "./hulls.js?v=fresh-20260916-2002-07db9a05";
import {
...
} from "./worldRecords.js?v=fresh-20260916-2002-07db9a05";
