import { getCurrentShipLegal, getPilotName, updateCurrentShipLegal } from "./legalRecords.js?v=fresh-20260804-2128-90ed81d";
import { canSpendCredits, getCredits, spendCredits } from "./accounts.js?v=fresh-20260804-2128-90ed81d";
import { registerHull, setActiveHull } from "./hulls.js?v=fresh-20260804-2128-90ed81d";
import {
...
} from "./worldRecords.js?v=fresh-20260804-2128-90ed81d";
