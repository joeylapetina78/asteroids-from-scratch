import { getCurrentShipLegal, getPilotName, updateCurrentShipLegal } from "./legalRecords.js?v=fresh-20260804-2047-0ceced2";
import { canSpendCredits, getCredits, spendCredits } from "./accounts.js?v=fresh-20260804-2047-0ceced2";
import { registerHull, setActiveHull } from "./hulls.js?v=fresh-20260804-2047-0ceced2";
import {
...
} from "./worldRecords.js?v=fresh-20260804-2047-0ceced2";
