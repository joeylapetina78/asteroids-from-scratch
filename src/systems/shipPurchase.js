import { getCurrentShipLegal, getPilotName, updateCurrentShipLegal } from "./legalRecords.js?v=fresh-20260822-1304-slipway";
import { canSpendCredits, getCredits, spendCredits } from "./accounts.js?v=fresh-20260822-1304-slipway";
import { registerHull, setActiveHull } from "./hulls.js?v=fresh-20260822-1304-slipway";
import {
...
} from "./worldRecords.js?v=fresh-20260822-1304-slipway";
