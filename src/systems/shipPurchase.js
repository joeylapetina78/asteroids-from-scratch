import { getCurrentShipLegal, getPilotName, updateCurrentShipLegal } from "./legalRecords.js?v=fresh-20260822-1344-layout";
import { canSpendCredits, getCredits, spendCredits } from "./accounts.js?v=fresh-20260822-1344-layout";
import { registerHull, setActiveHull } from "./hulls.js?v=fresh-20260822-1344-layout";
import {
...
} from "./worldRecords.js?v=fresh-20260822-1344-layout";
