import { getCurrentShipLegal, getPilotName, updateCurrentShipLegal } from "./legalRecords.js?v=fresh-20260808-2209-d56d3b0";
import { canSpendCredits, getCredits, spendCredits } from "./accounts.js?v=fresh-20260808-2209-d56d3b0";
import { registerHull, setActiveHull } from "./hulls.js?v=fresh-20260808-2209-d56d3b0";
import {
...
} from "./worldRecords.js?v=fresh-20260808-2209-d56d3b0";
