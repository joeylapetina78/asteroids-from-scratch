import { getCurrentShipLegal, getPilotName, updateCurrentShipLegal } from "./legalRecords.js?v=fresh-20260719-1259-cb7d5ac";
import { canSpendCredits, getCredits, spendCredits } from "./accounts.js?v=fresh-20260719-1259-cb7d5ac";
import { registerHull, setActiveHull } from "./hulls.js?v=fresh-20260719-1259-cb7d5ac";
import {
...
} from "./worldRecords.js?v=fresh-20260719-1259-cb7d5ac";
