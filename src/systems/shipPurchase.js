import { getCurrentShipLegal, getPilotName, updateCurrentShipLegal } from "./legalRecords.js?v=fresh-20260731-1824-94364a5";
import { canSpendCredits, getCredits, spendCredits } from "./accounts.js?v=fresh-20260731-1824-94364a5";
import { registerHull, setActiveHull } from "./hulls.js?v=fresh-20260731-1824-94364a5";
import {
...
} from "./worldRecords.js?v=fresh-20260731-1824-94364a5";
