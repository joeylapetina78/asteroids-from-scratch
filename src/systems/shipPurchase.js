import { getCurrentShipLegal, getPilotName, updateCurrentShipLegal } from "./legalRecords.js?v=fresh-20260811-2005-d6bdaee";
import { canSpendCredits, getCredits, spendCredits } from "./accounts.js?v=fresh-20260811-2005-d6bdaee";
import { registerHull, setActiveHull } from "./hulls.js?v=fresh-20260811-2005-d6bdaee";
import {
...
} from "./worldRecords.js?v=fresh-20260811-2005-d6bdaee";
