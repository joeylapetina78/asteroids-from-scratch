import { getCurrentShipLegal, getPilotName, updateCurrentShipLegal } from "./legalRecords.js?v=fresh-20260703-2059-1d6effa";
import { canSpendCredits, getCredits, spendCredits } from "./accounts.js?v=fresh-20260703-2059-1d6effa";
import { registerHull, setActiveHull } from "./hulls.js?v=fresh-20260703-2059-1d6effa";
import {
...
} from "./worldRecords.js?v=fresh-20260703-2059-1d6effa";
