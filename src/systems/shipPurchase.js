import { getCurrentShipLegal, getPilotName, updateCurrentShipLegal } from "./legalRecords.js?v=fresh-20260802-1504-d6b41cd";
import { canSpendCredits, getCredits, spendCredits } from "./accounts.js?v=fresh-20260802-1504-d6b41cd";
import { registerHull, setActiveHull } from "./hulls.js?v=fresh-20260802-1504-d6b41cd";
import {
...
} from "./worldRecords.js?v=fresh-20260802-1504-d6b41cd";
