import { getPilotLicense, getPilotName } from "./legalRecords.js?v=fresh-20260804-2128-90ed81d";
import { getShipAssetId } from "./worldRecords.js?v=fresh-20260804-2128-90ed81d";
