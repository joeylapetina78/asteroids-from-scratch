import { getPilotLicense, getPilotName } from "./legalRecords.js?v=fresh-20260703-2316-6619a4f";
import { getShipAssetId } from "./worldRecords.js?v=fresh-20260703-2316-6619a4f";
