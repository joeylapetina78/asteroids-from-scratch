import { FRONTIER_FREIGHT_CORRIDOR } from "../content/transportation/corridorArchetypes.js?v=fresh-20260916-2002-07db9a05";
import { createRandom, hashNumbers } from "./random.js?v=fresh-20260916-2002-07db9a05";
import { createProceduralSettlementSeed, registerGeneratedSettlement } from "./settlementSeedPipeline.js?v=fresh-20260916-2002-07db9a05";
import { createValueNoise } from "./valueNoise.js?v=fresh-20260916-2002-07db9a05";
import { getChunkTerrainProfile } from "./worldTerrain.js?v=fresh-20260916-2002-07db9a05";
import { sampleEnvironment } from "./worldHazards.js?v=fresh-20260916-2002-07db9a05";
import {
  ensureWorldNetwork, registerTradeCommunity, registerWorldConnection,
} from "./worldNetworkRegistry.js?v=fresh-20260916-2002-07db9a05";
