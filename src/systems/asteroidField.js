import { createCommonAsteroid, createRandomAsteroid } from "../entities/Asteroid.js?v=fresh-20260906-2112-823005ce";
import { createRandom, hashNumbers, randomRange } from "./random.js?v=fresh-20260906-2112-823005ce";
import { getResourceColor, getResourceFamily } from "./resourceDefinitions.js?v=fresh-20260906-2112-823005ce";
import { getAmbientSurvivalResourceWeights, mixResourceColor } from "./resourceField.js?v=fresh-20260906-2112-823005ce";
import { getChunkTerrainProfile } from "./worldTerrain.js?v=fresh-20260906-2112-823005ce";
import { getCorridorClearance } from "./transportCorridors.js?v=fresh-20260906-2112-823005ce";
