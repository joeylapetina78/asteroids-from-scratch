...
import { getEffectiveMaterialUnits, getInstitutionalFeedstockTradeValue, getPhysicalUnitsForEffective, getResourceFamily } from "./resourceDefinitions.js?v=fresh-20260908-1758-b90f0dde";
import { getImportFamilies, getInventoryPosition, getMinedFamilies } from "./hubInventory.js?v=fresh-20260908-1758-b90f0dde";
import { STANDING_MINING_ORDERS, getStandingMiningDefinitions } from "./miningOperation.js?v=fresh-20260908-1758-b90f0dde";
import { isHubAggregated } from "./simulationMode.js?v=fresh-20260908-1758-b90f0dde";
import { evaluateProcurement, evaluateSupplierAsk, urgencyFromCoverage } from "./valuation.js?v=fresh-20260908-1758-b90f0dde";
import { getUnitCost } from "./costBasis.js?v=fresh-20260908-1758-b90f0dde";
import { getActorOfferTypes, getActorProtectedCash, getActorTraits } from "./actorConfig.js?v=fresh-20260908-1758-b90f0dde";
import { BLOCKER_KIND, DIAGNOSTIC_STATE, clearBlocker, createBlocker, recordBlocker, recordDecision } from "./diagnostics.js?v=fresh-20260908-1758-b90f0dde";
import { getGoodwill, getRelationshipProjection } from "./relationshipProjections.js?v=fresh-20260908-1758-b90f0dde";
import { resolveNegotiationPolicy } from "./negotiation.js?v=fresh-20260908-1758-b90f0dde";
import { shouldActThisTick } from "./detailLevel.js?v=fresh-20260908-1758-b90f0dde";
import { createTransportationNetwork, findTransportationRoute } from "./transportationPlanning.js?v=fresh-20260908-1758-b90f0dde";
import { getRuntimeWorldConnections } from "./worldNetworkRegistry.js?v=fresh-20260908-1758-b90f0dde";
