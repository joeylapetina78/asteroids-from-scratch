...
const EXPLICIT_CLASSES = Object.freeze({
  ...
  "protection.craftDispatched": RETENTION_CLASS.OPERATIONAL,
  "protection.contractFailed": RETENTION_CLASS.DURABLE,
  "protection.contractPaid": RETENTION_CLASS.DURABLE,
