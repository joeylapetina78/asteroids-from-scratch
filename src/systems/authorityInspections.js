import { createShipPaperworkInspectionReport } from "./paperworkInspections.js?v=fresh-20260708-patrol3";
import { getRegistryEntityIdForSite, hasRegistryStatus } from "./entityRegistry.js?v=fresh-20260708-patrol3";
import { PUBLIC_IDENTITY_KIND } from "./publicIdentity.js?v=fresh-20260708-patrol3";
