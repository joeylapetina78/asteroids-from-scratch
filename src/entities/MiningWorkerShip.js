import { advanceFlightBody, getTurnTowardAngle, wrapAngle } from "../systems/flightPhysics.js?v=fresh-20260822-0010-4a2fda0d";
import { getEngineModel } from "../content/ships/engineModels.js?v=fresh-20260822-0010-4a2fda0d";
import { steerAroundObstacles } from "../systems/obstacleNavigation.js?v=fresh-20260822-0010-4a2fda0d";
import { normalizeResourceType } from "../systems/resourceDefinitions.js?v=fresh-20260822-0010-4a2fda0d";
import { addCommitment, createCommitmentPortfolio, moveCommitmentToFront, removeCommitment, remainingCapacity } from "../systems/commitmentPortfolio.js?v=fresh-20260822-0010-4a2fda0d";
