import { getProcessorOutputs, normalizeProcessorOutput } from "./components/componentRules.js?v=fresh-20260822-1326-partsmkt";
import { getResourceColor, getResourceGuideEntries, getResourceProcessValue, getResourceShape, getResourceTradeValue, normalizeResourceType } from "./systems/resourceDefinitions.js?v=fresh-20260822-1326-partsmkt";
import { ROCKMOSS_CRAWLER_TYPE, getStrainAppearance } from "./systems/rockmossStrains.js?v=fresh-20260822-1326-partsmkt";
import { sellMaterialToHub } from "./systems/hubInventory.js?v=fresh-20260822-1326-partsmkt";
import { RIFT_TROPHY_RESOURCE_TYPE } from "./systems/hostileLoot.js?v=fresh-20260822-1326-partsmkt";
import { ensureGateBounty, redeemGateTrophy } from "./systems/gateBounty.js?v=fresh-20260822-1326-partsmkt";
import { addToTank } from "./systems/panelMaintenance.js?v=fresh-20260822-1326-partsmkt";
import { ENGINE_CONDITION_CONFIG } from "./systems/engineCondition.js?v=fresh-20260822-1326-partsmkt";
import { MINER_CONDITION_CONFIG } from "./systems/minerCondition.js?v=fresh-20260822-1326-partsmkt";
import { COLLECTOR_CONDITION_CONFIG } from "./systems/collectorCondition.js?v=fresh-20260822-1326-partsmkt";
import { DEFAULT_ENGINE_MODEL_ID, getEngineModel } from "./content/ships/engineModels.js?v=fresh-20260822-1326-partsmkt";
import { drawResourceShape } from "./entities/ResourcePickup.js?v=fresh-20260822-1326-partsmkt";
import { shipOffers } from "./content/ships/shipOffers.js?v=fresh-20260822-1326-partsmkt";
import { chapterOneRoute, storyRegions, yardExchangeServices } from "./content/storyWorld.js?v=fresh-20260822-1326-partsmkt";
import { Game } from "./game.js?v=fresh-20260822-1326-partsmkt";
import { createContractManager, registerContractDefinition } from "./systems/contractManager.js?v=fresh-20260822-1326-partsmkt";
import { acquireWreckForSprc, createWreckSalvageContract } from "./systems/wreckRegistry.js?v=fresh-20260822-1326-partsmkt";
import { COMMS_SOURCES, createCommsDirector } from "./systems/commsDirector.js?v=fresh-20260822-1326-partsmkt";
import { createGameAudio } from "./systems/audio.js?v=fresh-20260822-1326-partsmkt";
import { canSpendCredits, depositCredits, getCredits, spendCredits } from "./systems/accounts.js?v=fresh-20260822-1326-partsmkt";
import {
  getHubServiceBehavior,
  getHubServicePrompt,
  getServiceTypesForPanel,
  shouldKeepServiceWindowOpen,
} from "./systems/hubServiceBehaviors.js?v=fresh-20260822-1326-partsmkt";
import { getAllHubServiceContractIds, getInProgressServiceContractId, getNextHubServiceContractId, isServiceContractLadderComplete } from "./systems/hubServiceContracts.js?v=fresh-20260822-1326-partsmkt";
import { getHubService, getHubServices } from "./systems/hubServices.js?v=fresh-20260822-1326-partsmkt";
import { syncActiveHullFromComponents } from "./systems/hulls.js?v=fresh-20260822-1326-partsmkt";
import { createJourneyDirector } from "./systems/journeyDirector.js?v=fresh-20260822-1326-partsmkt";
import { COMPONENT_STATE_BY_PANEL_ID } from "./systems/componentRegistry.js?v=fresh-20260822-1326-partsmkt";
import { getRegistryEntityIdForSite, getRegistrySubject } from "./systems/entityRegistry.js?v=fresh-20260822-1326-partsmkt";
import { getPilotLicense, issuePilotLicense, registerStarterDeliveryShipRecords, updateCurrentShipLegal } from "./systems/legalRecords.js?v=fresh-20260822-1326-partsmkt";
import { createShipPaperworkInspectionReport } from "./systems/paperworkInspections.js?v=fresh-20260822-1326-partsmkt";
import { Processor } from "./systems/processor.js?v=fresh-20260822-1326-partsmkt";
import { clearSavedProfile, getDevStart, loadSavedProfile, peekSavedDevStartId, restoreSavedWorld, saveProfile, shouldResetSave } from "./systems/saveManager.js?v=fresh-20260822-1326-partsmkt";
import { purchaseShipOffer } from "./systems/shipPurchase.js?v=fresh-20260822-1326-partsmkt";
import { createGameState } from "./state/gameState.js?v=fresh-20260822-1326-partsmkt";
import { createSprcOperation, SPRC } from "./systems/sprcOperation.js?v=fresh-20260822-1326-partsmkt";
import { createFarmOperation, FARM_INSPECTION_SERVICE_ID } from "./systems/farmOperation.js?v=fresh-20260822-1326-partsmkt";
import { INSTITUTION_ARCHETYPES } from "./content/institutions/institutionArchetypes.js?v=fresh-20260822-1326-partsmkt";
import { createLogisticsManager, REGIONAL_HAULER_FLOOR } from "./systems/logistics.js?v=fresh-20260822-1326-partsmkt";
import { createTowServiceManager } from "./systems/towService.js?v=fresh-20260822-1326-partsmkt";
import { createFleetInsuranceManager } from "./systems/fleetInsurance.js?v=fresh-20260822-1326-partsmkt";
import { createFleetProtectionManager } from "./systems/fleetProtection.js?v=fresh-20260822-1326-partsmkt";
import { acceptPlayerProtectionRequest } from "./systems/protectionProviders.js?v=fresh-20260822-1326-partsmkt";
import { getPlayerProtectionJobsForSite } from "./systems/protectionPlanning.js?v=fresh-20260822-1326-partsmkt";
import { createMiningOperation, getStandingMiningOrderAvailability } from "./systems/miningOperation.js?v=fresh-20260822-1326-partsmkt";
import { FLINT_MINING_SEED } from "./content/economy/miningInstitutions.js?v=fresh-20260822-1326-partsmkt";
import { createPopulationOperation } from "./systems/populationDemand.js?v=fresh-20260822-1326-partsmkt";
import { createHubProcurementOperation } from "./systems/hubProcurement.js?v=fresh-20260822-1326-partsmkt";
import { createIndustrialProductionOperation } from "./systems/industrialProduction.js?v=fresh-20260822-1326-partsmkt";
import { advanceShipyards } from "./systems/shipyards.js?v=fresh-20260822-1326-partsmkt";
import { createHubPlanningOperation } from "./systems/hubPlanning.js?v=fresh-20260822-1326-partsmkt";
import { createNpcDevelopmentOperation } from "./systems/npcDevelopment.js?v=fresh-20260822-1326-partsmkt";
import { createDistantSimulationOperation } from "./systems/distantSimulation.js?v=fresh-20260822-1326-partsmkt";
import { SIMULATION_REASON, summarizeSimulationDetail } from "./systems/simulationObservatory.js?v=fresh-20260822-1326-partsmkt";
import { summarizePlayerTerritoryRights } from "./systems/hubTerritories.js?v=fresh-20260822-1326-partsmkt";
import { TICK_PHASE, createWorldClock } from "./systems/worldClock.js?v=fresh-20260822-1326-partsmkt";
import { refreshMiningOrderBook } from "./systems/miningOperation.js?v=fresh-20260822-1326-partsmkt";
import { issueWorldDocument } from "./systems/worldRecords.js?v=fresh-20260822-1326-partsmkt";
import { inspectActor, listInspectableActors } from "./systems/actorInspector.js?v=fresh-20260822-1326-partsmkt";
import { listBlocked } from "./systems/diagnostics.js?v=fresh-20260822-1326-partsmkt";
import { CONTRACT_STATE, filterContracts, listContractParties, listContracts, summarizeContracts } from "./systems/contractBoard.js?v=fresh-20260822-1326-partsmkt";
import { collectFilterOptions, describeEvent, describeEventRetention, extractEventReferences, filterEvents, getEventVisibility, sortEvents, summarizeEvent } from "./systems/ledgerQuery.js?v=fresh-20260822-1326-partsmkt";
import { ECONOMY_WINDOWS, SAMPLE_INTERVAL_MS, collectSeriesKeys, ensureEconomyHistory, getEconomySamples, latestValue, reconcileMoney, recordEconomySample, seriesChange, toRateSeries, toSeries } from "./systems/economySampler.js?v=fresh-20260822-1326-partsmkt";
import { colorForKey, createBarChart, createGroupedBarChart, createLineChart, createStackedAreaChart, createStatTile, formatCredits, formatRate, formatUnits } from "./systems/economyCharts.js?v=fresh-20260822-1326-partsmkt";
