import { getProcessorOutputs, normalizeProcessorOutput } from "./components/componentRules.js?v=fresh-20260820-2130-fede47f";
import { getResourceColor, getResourceGuideEntries, getResourceProcessValue, getResourceShape, getResourceTradeValue, normalizeResourceType } from "./systems/resourceDefinitions.js?v=fresh-20260820-2130-fede47f";
import { ROCKMOSS_CRAWLER_TYPE, getStrainAppearance } from "./systems/rockmossStrains.js?v=fresh-20260820-2130-fede47f";
import { sellMaterialToHub } from "./systems/hubInventory.js?v=fresh-20260820-2130-fede47f";
import { RIFT_TROPHY_RESOURCE_TYPE } from "./systems/hostileLoot.js?v=fresh-20260820-2130-fede47f";
import { ensureGateBounty, redeemGateTrophy } from "./systems/gateBounty.js?v=fresh-20260820-2130-fede47f";
import { addToTank } from "./systems/panelMaintenance.js?v=fresh-20260820-2130-fede47f";
import { ENGINE_CONDITION_CONFIG } from "./systems/engineCondition.js?v=fresh-20260820-2130-fede47f";
import { MINER_CONDITION_CONFIG } from "./systems/minerCondition.js?v=fresh-20260820-2130-fede47f";
import { COLLECTOR_CONDITION_CONFIG } from "./systems/collectorCondition.js?v=fresh-20260820-2130-fede47f";
import { DEFAULT_ENGINE_MODEL_ID, getEngineModel } from "./content/ships/engineModels.js?v=fresh-20260820-2130-fede47f";
import { drawResourceShape } from "./entities/ResourcePickup.js?v=fresh-20260820-2130-fede47f";
import { shipOffers } from "./content/ships/shipOffers.js?v=fresh-20260820-2130-fede47f";
import { chapterOneRoute, storyRegions, yardExchangeServices } from "./content/storyWorld.js?v=fresh-20260820-2130-fede47f";
import { Game } from "./game.js?v=fresh-20260820-2130-fede47f";
import { createContractManager, registerContractDefinition } from "./systems/contractManager.js?v=fresh-20260820-2130-fede47f";
import { acquireWreckForSprc, createWreckSalvageContract } from "./systems/wreckRegistry.js?v=fresh-20260820-2130-fede47f";
import { COMMS_SOURCES, createCommsDirector } from "./systems/commsDirector.js?v=fresh-20260820-2130-fede47f";
import { createGameAudio } from "./systems/audio.js?v=fresh-20260820-2130-fede47f";
import { canSpendCredits, depositCredits, getCredits, spendCredits } from "./systems/accounts.js?v=fresh-20260820-2130-fede47f";
import {
  getHubServiceBehavior,
  getHubServicePrompt,
  getServiceTypesForPanel,
  shouldKeepServiceWindowOpen,
} from "./systems/hubServiceBehaviors.js?v=fresh-20260820-2130-fede47f";
import { getAllHubServiceContractIds, getInProgressServiceContractId, getNextHubServiceContractId, isServiceContractLadderComplete } from "./systems/hubServiceContracts.js?v=fresh-20260820-2130-fede47f";
import { getHubService, getHubServices } from "./systems/hubServices.js?v=fresh-20260820-2130-fede47f";
import { syncActiveHullFromComponents } from "./systems/hulls.js?v=fresh-20260820-2130-fede47f";
import { createJourneyDirector } from "./systems/journeyDirector.js?v=fresh-20260820-2130-fede47f";
import { COMPONENT_STATE_BY_PANEL_ID } from "./systems/componentRegistry.js?v=fresh-20260820-2130-fede47f";
import { getRegistryEntityIdForSite, getRegistrySubject } from "./systems/entityRegistry.js?v=fresh-20260820-2130-fede47f";
import { getPilotLicense, issuePilotLicense, registerStarterDeliveryShipRecords, updateCurrentShipLegal } from "./systems/legalRecords.js?v=fresh-20260820-2130-fede47f";
import { createShipPaperworkInspectionReport } from "./systems/paperworkInspections.js?v=fresh-20260820-2130-fede47f";
import { Processor } from "./systems/processor.js?v=fresh-20260820-2130-fede47f";
import { clearSavedProfile, getDevStart, loadSavedProfile, peekSavedDevStartId, restoreSavedWorld, saveProfile, shouldResetSave } from "./systems/saveManager.js?v=fresh-20260820-2130-fede47f";
import { purchaseShipOffer } from "./systems/shipPurchase.js?v=fresh-20260820-2130-fede47f";
import { createGameState } from "./state/gameState.js?v=fresh-20260820-2130-fede47f";
import { createSprcOperation, SPRC } from "./systems/sprcOperation.js?v=fresh-20260820-2130-fede47f";
import { createFarmOperation, FARM_INSPECTION_SERVICE_ID } from "./systems/farmOperation.js?v=fresh-20260820-2130-fede47f";
import { INSTITUTION_ARCHETYPES } from "./content/institutions/institutionArchetypes.js?v=fresh-20260820-2130-fede47f";
import { createLogisticsManager, REGIONAL_HAULER_FLOOR } from "./systems/logistics.js?v=fresh-20260820-2130-fede47f";
import { createTowServiceManager } from "./systems/towService.js?v=fresh-20260820-2130-fede47f";
import { createFleetInsuranceManager } from "./systems/fleetInsurance.js?v=fresh-20260820-2130-fede47f";
import { createFleetProtectionManager } from "./systems/fleetProtection.js?v=fresh-20260820-2130-fede47f";
import { acceptPlayerProtectionRequest } from "./systems/protectionProviders.js?v=fresh-20260820-2130-fede47f";
import { getPlayerProtectionJobsForSite } from "./systems/protectionPlanning.js?v=fresh-20260820-2130-fede47f";
import { createMiningOperation, getStandingMiningOrderAvailability } from "./systems/miningOperation.js?v=fresh-20260820-2130-fede47f";
import { FLINT_MINING_SEED } from "./content/economy/miningInstitutions.js?v=fresh-20260820-2130-fede47f";
import { createPopulationOperation } from "./systems/populationDemand.js?v=fresh-20260820-2130-fede47f";
import { createHubProcurementOperation } from "./systems/hubProcurement.js?v=fresh-20260820-2130-fede47f";
import { createIndustrialProductionOperation } from "./systems/industrialProduction.js?v=fresh-20260820-2130-fede47f";
import { createHubPlanningOperation } from "./systems/hubPlanning.js?v=fresh-20260820-2130-fede47f";
import { createNpcDevelopmentOperation } from "./systems/npcDevelopment.js?v=fresh-20260820-2130-fede47f";
import { createDistantSimulationOperation } from "./systems/distantSimulation.js?v=fresh-20260820-2130-fede47f";
import { SIMULATION_REASON, summarizeSimulationDetail } from "./systems/simulationObservatory.js?v=fresh-20260820-2130-fede47f";
import { summarizePlayerTerritoryRights } from "./systems/hubTerritories.js?v=fresh-20260820-2130-fede47f";
import { TICK_PHASE, createWorldClock } from "./systems/worldClock.js?v=fresh-20260820-2130-fede47f";
import { refreshMiningOrderBook } from "./systems/miningOperation.js?v=fresh-20260820-2130-fede47f";
import { issueWorldDocument } from "./systems/worldRecords.js?v=fresh-20260820-2130-fede47f";
import { inspectActor, listInspectableActors } from "./systems/actorInspector.js?v=fresh-20260820-2130-fede47f";
import { listBlocked } from "./systems/diagnostics.js?v=fresh-20260820-2130-fede47f";
import { CONTRACT_STATE, filterContracts, listContractParties, listContracts, summarizeContracts } from "./systems/contractBoard.js?v=fresh-20260820-2130-fede47f";
import { collectFilterOptions, describeEvent, describeEventRetention, extractEventReferences, filterEvents, getEventVisibility, sortEvents, summarizeEvent } from "./systems/ledgerQuery.js?v=fresh-20260820-2130-fede47f";
import { ECONOMY_WINDOWS, SAMPLE_INTERVAL_MS, collectSeriesKeys, ensureEconomyHistory, getEconomySamples, latestValue, reconcileMoney, recordEconomySample, seriesChange, toRateSeries, toSeries } from "./systems/economySampler.js?v=fresh-20260820-2130-fede47f";
import { colorForKey, createBarChart, createGroupedBarChart, createLineChart, createStackedAreaChart, createStatTile, formatCredits, formatRate, formatUnits } from "./systems/economyCharts.js?v=fresh-20260820-2130-fede47f";
