import { FIRST_REACH_CARRIER_POLICY, FIRST_REACH_REPAIR_OPTIONS } from "./firstReachNetwork.js?v=fresh-20260910-1723-7b622d5f";
...
export const FIRST_REACH_CARRIERS = Object.freeze([
  Object.freeze({
    ...
    ship: { id: "ship:hauler-yard-scrap", physicalId: "hauler-yard-scrap", name: "Yard Hauler", referenceId: "HAUL-01-HAULER-YARD-SCRAP", archetypeId: "cargo-ship", ownerInstitutionId: "carrier:yard-hauler", controllerInstitutionId: "carrier:yard-hauler", wear: 0.4, issueCount: 0, homeSiteId: "yard-exchange", initialDestinationSiteId: "scrap-porch", seed: 1 },
  ...
  Object.freeze({
    ...
    ship: { id: "ship:hauler-scrap-yard", physicalId: "hauler-scrap-yard", name: "Porch Runner Two", referenceId: "HAUL-02-HAULER-SCRAP-YARD", archetypeId: "cargo-ship", ownerInstitutionId: "carrier:porch-runner", controllerInstitutionId: "carrier:porch-runner", wear: 0.72, issueCount: 0, homeSiteId: "scrap-porch", initialDestinationSiteId: "yard-exchange", seed: 2 },
    policy: { ...FIRST_REACH_CARRIER_POLICY, minimumOperatingCash: 1800 }, repairOptions: FIRST_REACH_REPAIR_OPTIONS,
  ...
  Object.freeze({
    ...
    ship: { id: "ship:lantern-runner", physicalId: "hauler-lantern-runner", name: "Lantern Runner", referenceId: "HAUL-037-LANTERN", archetypeId: "cargo-ship", ownerInstitutionId: "carrier:lantern-cartage", controllerInstitutionId: "carrier:lantern-cartage", wear: 0.56, issueCount: 0, homeSiteId: "blue-lantern", initialDestinationSiteId: "yard-exchange", seed: 3 },
