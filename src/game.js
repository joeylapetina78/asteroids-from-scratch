import { Bullet } from "./entities/Bullet.js?v=fresh-20260801-0014-16743da";
import { breakAsteroid, WHITE_ASTEROID_COLOR } from "./entities/Asteroid.js?v=fresh-20260801-0014-16743da";
import { createResourcePickupsFromAsteroid, ResourcePickup } from "./entities/ResourcePickup.js?v=fresh-20260801-0014-16743da";
import { drawResourceShape } from "./entities/ResourcePickup.js?v=fresh-20260801-0014-16743da";
import { Ship } from "./entities/Ship.js?v=fresh-20260801-0014-16743da";
import { createAsteroidChunks } from "./systems/asteroidField.js?v=fresh-20260801-0014-16743da";
import { applyPanelPatch, HULL_REPAIR_DELAY_SECONDS, HULL_REPAIR_RATE, accumulatePanelWear, ensurePanelCondition, panelStageIndex, repairPanelCondition } from "./systems/panelMaintenance.js?v=fresh-20260801-0014-16743da";
import { ENGINE_CONDITION_CONFIG, computeEngineWearDelta, getEngineStageEffects } from "./systems/engineCondition.js?v=fresh-20260801-0014-16743da";
import { createCamera } from "./systems/camera.js?v=fresh-20260801-0014-16743da";
import { createInput } from "./systems/input.js?v=fresh-20260801-0014-16743da";
import { createAmbientLifeBatch, createHunterNearShip, createHunterRespawn, createLifeField, seedChunkRockmoss } from "./systems/lifeField.js?v=fresh-20260801-0014-16743da";
import { ROCKMOSS_STRAINS } from "./systems/rockmossStrains.js?v=fresh-20260801-0014-16743da";
import { createNpcRouteShips, createRouteShip } from "./systems/npcRoutes.js?v=fresh-20260801-0014-16743da";
import { clearScreen, drawGrid, drawVector, isVisible } from "./systems/rendering.js?v=fresh-20260801-0014-16743da";
import { createResourceField } from "./systems/resourceField.js?v=fresh-20260801-0014-16743da";
import { createScanner } from "./systems/scanner.js?v=fresh-20260801-0014-16743da";
import { createDriftMouthField } from "./systems/driftMouthField.js?v=fresh-20260801-0014-16743da";
import { createIncursionField } from "./systems/incursionField.js?v=fresh-20260801-0014-16743da";
import { injectBountyJobs } from "./systems/bountyContracts.js?v=fresh-20260801-0014-16743da";
import { injectCargoRuns } from "./systems/cargoContracts.js?v=fresh-20260801-0014-16743da";
import { getStandingFreightJobsForSite } from "./systems/logistics.js?v=fresh-20260801-0014-16743da";
import { FIRST_REACH_TRANSPORT_CONNECTIONS } from "./content/transportation/firstReachNetwork.js?v=fresh-20260801-0014-16743da";
import { applyCorridorMaintenance, createTransportCorridors, getCorridorClearance } from "./systems/transportCorridors.js?v=fresh-20260801-0014-16743da";
import { getStandingMiningJobsForSite } from "./systems/miningOperation.js?v=fresh-20260801-0014-16743da";
import { generateSurveyContractDefinition, generateSurveyJobBoardDefinitions } from "./systems/surveyContracts.js?v=fresh-20260801-0014-16743da";
import { createEncounterDirector } from "./systems/encounterDirector.js?v=fresh-20260801-0014-16743da";
import { createPortalTrophy, getHostileLootCount, rollHostileLoot } from "./systems/hostileLoot.js?v=fresh-20260801-0014-16743da";
import { createThreadwyrmField } from "./systems/threadwyrmField.js?v=fresh-20260801-0014-16743da";
import { recordVisitedZone } from "./systems/legalRecords.js?v=fresh-20260801-0014-16743da";
import { getSectorDesignation } from "./systems/sectorCodes.js?v=fresh-20260801-0014-16743da";
import { sampleEnvironment, getFlowAngle } from "./systems/worldHazards.js?v=fresh-20260801-0014-16743da";
import { inspectPublicIdentity } from "./systems/authorityInspections.js?v=fresh-20260801-0014-16743da";
import { getRegistryEntityIdForSite, getRegistrySubject, rememberRegistrySubject } from "./systems/entityRegistry.js?v=fresh-20260801-0014-16743da";
import { createControlledShipPublicIdentity, createNpcShipPublicIdentity } from "./systems/publicIdentity.js?v=fresh-20260801-0014-16743da";
import { getZoneProfile, WORLD_ZONES, getZoneInfluence } from "./systems/worldZones.js?v=fresh-20260801-0014-16743da";
import { getRegionProfile } from "./systems/worldRegions.js?v=fresh-20260801-0014-16743da";
import { createClaimField } from "./systems/claimField.js?v=fresh-20260801-0014-16743da";
import { getNearbyWorldSite, getNearestWorldSite, getWorldSites, isInSiteRange } from "./systems/worldSites.js?v=fresh-20260801-0014-16743da";
import { createGameState } from "./state/gameState.js?v=fresh-20260801-0014-16743da";
import { canSpendCredits, debitCredits, depositCredits, getCredits, spendCredits } from "./systems/accounts.js?v=fresh-20260801-0014-16743da";
import { getResourceColor, getResourceShape } from "./systems/resourceDefinitions.js?v=fresh-20260801-0014-16743da";
...
export class Game {
  constructor(
    ...
    this.commissionHauler = ({ id, name, homeSiteId, seed }) => {
      ...
      const ship = createRouteShip(id, name, [home, other], seed ?? 9, -140, `${name} Operator`, other.id);
  ...
  generateSurveyJobBoard(site, issuer = null) {
    ...
    return [...jobs, ...getStandingMiningJobsForSite(site.id, issuer, this.state), ...getStandingFreightJobsForSite(site.id, issuer, this.state)];
  }
