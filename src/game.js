import { Bullet } from "./entities/Bullet.js?v=fresh-20260730-0650-ae6e94a";
import { breakAsteroid, WHITE_ASTEROID_COLOR } from "./entities/Asteroid.js?v=fresh-20260730-0650-ae6e94a";
import { createResourcePickupsFromAsteroid, ResourcePickup } from "./entities/ResourcePickup.js?v=fresh-20260730-0650-ae6e94a";
import { drawResourceShape } from "./entities/ResourcePickup.js?v=fresh-20260730-0650-ae6e94a";
import { Ship } from "./entities/Ship.js?v=fresh-20260730-0650-ae6e94a";
import { createAsteroidChunks } from "./systems/asteroidField.js?v=fresh-20260730-0650-ae6e94a";
import { applyPanelPatch, HULL_REPAIR_DELAY_SECONDS, HULL_REPAIR_RATE, accumulatePanelWear, ensurePanelCondition, panelStageIndex, repairPanelCondition } from "./systems/panelMaintenance.js?v=fresh-20260730-0650-ae6e94a";
import { ENGINE_CONDITION_CONFIG, computeEngineWearDelta, getEngineStageEffects } from "./systems/engineCondition.js?v=fresh-20260730-0650-ae6e94a";
import { createCamera } from "./systems/camera.js?v=fresh-20260730-0650-ae6e94a";
import { createInput } from "./systems/input.js?v=fresh-20260730-0650-ae6e94a";
import { createAmbientLifeBatch, createHunterNearShip, createHunterRespawn, createLifeField, seedChunkRockmoss } from "./systems/lifeField.js?v=fresh-20260730-0650-ae6e94a";
import { ROCKMOSS_STRAINS } from "./systems/rockmossStrains.js?v=fresh-20260730-0650-ae6e94a";
import { createNpcRouteShips } from "./systems/npcRoutes.js?v=fresh-20260730-0650-ae6e94a";
import { clearScreen, drawGrid, drawVector, isVisible } from "./systems/rendering.js?v=fresh-20260730-0650-ae6e94a";
import { createResourceField } from "./systems/resourceField.js?v=fresh-20260730-0650-ae6e94a";
import { createScanner } from "./systems/scanner.js?v=fresh-20260730-0650-ae6e94a";
import { createDriftMouthField } from "./systems/driftMouthField.js?v=fresh-20260730-0650-ae6e94a";
import { createIncursionField } from "./systems/incursionField.js?v=fresh-20260730-0650-ae6e94a";
import { injectBountyJobs } from "./systems/bountyContracts.js?v=fresh-20260730-0650-ae6e94a";
import { injectCargoRuns } from "./systems/cargoContracts.js?v=fresh-20260730-0650-ae6e94a";
import { getStandingFreightJobsForSite } from "./systems/logistics.js?v=fresh-20260730-0650-ae6e94a";
import { FIRST_REACH_TRANSPORT_CONNECTIONS } from "./content/transportation/firstReachNetwork.js?v=fresh-20260730-0650-ae6e94a";
import { applyCorridorMaintenance, createTransportCorridors, getCorridorClearance } from "./systems/transportCorridors.js?v=fresh-20260730-0650-ae6e94a";
import { getStandingMiningJobsForSite } from "./systems/miningOperation.js?v=fresh-20260730-0650-ae6e94a";
import { generateSurveyContractDefinition, generateSurveyJobBoardDefinitions } from "./systems/surveyContracts.js?v=fresh-20260730-0650-ae6e94a";
import { createEncounterDirector } from "./systems/encounterDirector.js?v=fresh-20260730-0650-ae6e94a";
import { createPortalTrophy, getHostileLootCount, rollHostileLoot } from "./systems/hostileLoot.js?v=fresh-20260730-0650-ae6e94a";
import { createThreadwyrmField } from "./systems/threadwyrmField.js?v=fresh-20260730-0650-ae6e94a";
import { recordVisitedZone } from "./systems/legalRecords.js?v=fresh-20260730-0650-ae6e94a";
import { getSectorDesignation } from "./systems/sectorCodes.js?v=fresh-20260730-0650-ae6e94a";
import { sampleEnvironment, getFlowAngle } from "./systems/worldHazards.js?v=fresh-20260730-0650-ae6e94a";
import { inspectPublicIdentity } from "./systems/authorityInspections.js?v=fresh-20260730-0650-ae6e94a";
import { getRegistryEntityIdForSite, getRegistrySubject, rememberRegistrySubject } from "./systems/entityRegistry.js?v=fresh-20260730-0650-ae6e94a";
import { createControlledShipPublicIdentity, createNpcShipPublicIdentity } from "./systems/publicIdentity.js?v=fresh-20260730-0650-ae6e94a";
import { getZoneProfile, WORLD_ZONES, getZoneInfluence } from "./systems/worldZones.js?v=fresh-20260730-0650-ae6e94a";
import { getRegionProfile } from "./systems/worldRegions.js?v=fresh-20260730-0650-ae6e94a";
import { createClaimField } from "./systems/claimField.js?v=fresh-20260730-0650-ae6e94a";
import { getNearbyWorldSite, getNearestWorldSite, getWorldSites, isInSiteRange } from "./systems/worldSites.js?v=fresh-20260730-0650-ae6e94a";
import { createGameState } from "./state/gameState.js?v=fresh-20260730-0650-ae6e94a";
import { canSpendCredits, debitCredits, depositCredits, getCredits, spendCredits } from "./systems/accounts.js?v=fresh-20260730-0650-ae6e94a";
import { getResourceColor, getResourceShape } from "./systems/resourceDefinitions.js?v=fresh-20260730-0650-ae6e94a";
...
export class Game {
  ...
  generateSurveyJobBoard(site, issuer = null) {
    ...
    return [...jobs, ...getStandingMiningJobsForSite(site.id, issuer), ...getStandingFreightJobsForSite(site.id, issuer)];
  }
  ...
  updateNpcShips(activeAsteroids, deltaSeconds) {
    this.npcShips.forEach((ship) => {
      ship.wearMode = this.state._devStartId ? "accelerated" : "normal";
