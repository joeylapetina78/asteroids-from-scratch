import { Bullet } from "./entities/Bullet.js?v=fresh-20260919-1538-9d02b382";
import { steerAroundObstacles } from "./systems/obstacleNavigation.js?v=fresh-20260919-1538-9d02b382";
import { getHullOutline } from "./content/ships/hullOutlines.js?v=fresh-20260919-1538-9d02b382";
import { getBuildProgress } from "./systems/shipyards.js?v=fresh-20260919-1538-9d02b382";
import { facilityOffset } from "./systems/hubLayout.js?v=fresh-20260919-1538-9d02b382";
import { VIEWPORT_SCOPE_MARGIN } from "./systems/cockpitSnap.js?v=fresh-20260919-1538-9d02b382";
import { infrastructureNavigationObstacles } from "./systems/infrastructureNavigation.js?v=fresh-20260919-1538-9d02b382";
import { breakAsteroid, WHITE_ASTEROID_COLOR } from "./entities/Asteroid.js?v=fresh-20260919-1538-9d02b382";
import { createResourcePickupsFromAsteroid, ResourcePickup } from "./entities/ResourcePickup.js?v=fresh-20260919-1538-9d02b382";
import { drawResourceShape } from "./entities/ResourcePickup.js?v=fresh-20260919-1538-9d02b382";
import { Ship } from "./entities/Ship.js?v=fresh-20260919-1538-9d02b382";
import { ShipWreck } from "./entities/ShipWreck.js?v=fresh-20260919-1538-9d02b382";
import { completeWreckSalvage, registerOwnedWreck } from "./systems/wreckRegistry.js?v=fresh-20260919-1538-9d02b382";
import { createAsteroidChunks, getOreClusterSeedsInRadius } from "./systems/asteroidField.js?v=fresh-20260919-1538-9d02b382";
import { applyPanelPatch, getHullRepairRateMultiplier, HULL_REPAIR_DELAY_SECONDS, HULL_REPAIR_RATE, accumulatePanelWear, ensurePanelCondition, panelStageIndex, repairPanelCondition } from "./systems/panelMaintenance.js?v=fresh-20260919-1538-9d02b382";
import { ENGINE_CONDITION_CONFIG, computeEngineWearDelta, getEngineStageEffects } from "./systems/engineCondition.js?v=fresh-20260919-1538-9d02b382";
import { MINER_CONDITION_CONFIG, computeMinerWearPerShot, getMinerStageEffects } from "./systems/minerCondition.js?v=fresh-20260919-1538-9d02b382";
import { COLLECTOR_CONDITION_CONFIG, computeCollectorWearPerSecond, getCollectorStageEffects } from "./systems/collectorCondition.js?v=fresh-20260919-1538-9d02b382";
import { createCamera } from "./systems/camera.js?v=fresh-20260919-1538-9d02b382";
import { createInput } from "./systems/input.js?v=fresh-20260919-1538-9d02b382";
import { GREATBLOOM_EYE_RADIUS } from "./entities/Lifeform.js?v=fresh-20260919-1538-9d02b382";
import { BLOOM_HARVEST_RESOURCE, BLOOM_KILLS_PER_GREATBLOOM, createAmbientLifeBatch, createGrazerAtFeast, createHunterNearShip, createHunterRespawn, createLifeField, createSurfacingGreatbloom, rollBloomHarvest, seedChunkRockmoss } from "./systems/lifeField.js?v=fresh-20260919-1538-9d02b382";
import { ROCKMOSS_CRAWLER_TYPE, ROCKMOSS_STRAINS, pickRockmossStrain } from "./systems/rockmossStrains.js?v=fresh-20260919-1538-9d02b382";
import { GRAZING_DEFAULTS, advanceGrazing, condenseDistantApexGrazers, condenseGrazerPopulation, enforceEcologicalBiomassBudget, findGrazingClusters, getGrazerSporeYield, isRipe } from "./systems/grazing.js?v=fresh-20260919-1538-9d02b382";
import { createRandom, hashNumbers } from "./systems/random.js?v=fresh-20260919-1538-9d02b382";
import { HAULER_PALETTES, RELIEF_HAULER_PALETTE, createNpcRouteShips, createRouteShip } from "./systems/npcRoutes.js?v=fresh-20260919-1538-9d02b382";
import { clearScreen, drawGrid, drawVector, isVisible } from "./systems/rendering.js?v=fresh-20260919-1538-9d02b382";
import { createResourceField } from "./systems/resourceField.js?v=fresh-20260919-1538-9d02b382";
import { createScanner } from "./systems/scanner.js?v=fresh-20260919-1538-9d02b382";
import { createDriftMouthField } from "./systems/driftMouthField.js?v=fresh-20260919-1538-9d02b382";
import { createIncursionField, createSeededDevice } from "./systems/incursionField.js?v=fresh-20260919-1538-9d02b382";
import { completeInternalProtectionResponse, ensurePatrolOperations, failInternalProtectionResponse, finishInternalProtectionReturn, getAvailablePatrolCraft, markPatrolCraftStatus, servicePatrolCraft, startInternalProtectionResponse } from "./systems/patrolOperations.js?v=fresh-20260919-1538-9d02b382";
import { createPatrolRuntimeActor } from "./systems/patrolRuntime.js?v=fresh-20260919-1538-9d02b382";
import { listPendingPatrolResponses } from "./systems/patrolDispatch.js?v=fresh-20260919-1538-9d02b382";
import { closeProtectionRequestsForThreat, evaluateProtectionThreat, getPlayerProtectionJobsForSite, reviewProtectionRequests } from "./systems/protectionPlanning.js?v=fresh-20260919-1538-9d02b382";
import { completePlayerProtectionRequest, completeProtectionContract, ensureProtectionProviders, failProtectionContract, finishProtectionReturn, serviceProtectionProviders, startProtectionContract } from "./systems/protectionProviders.js?v=fresh-20260919-1538-9d02b382";
import { fileAttackReport, nearestActiveReport, resolveAttackReport } from "./systems/securityReports.js?v=fresh-20260919-1538-9d02b382";
import { injectBountyJobs } from "./systems/bountyContracts.js?v=fresh-20260919-1538-9d02b382";
import { injectCargoRuns } from "./systems/cargoContracts.js?v=fresh-20260919-1538-9d02b382";
import { getStandingFreightJobsForSite } from "./systems/logistics.js?v=fresh-20260919-1538-9d02b382";
import { getRuntimeWorldConnections, getRuntimeWorldSites } from "./systems/worldNetworkRegistry.js?v=fresh-20260919-1538-9d02b382";
import { applyCorridorMaintenance, createTransportCorridors, getCorridorClearance } from "./systems/transportCorridors.js?v=fresh-20260919-1538-9d02b382";
import { getStandingMiningJobsForSite } from "./systems/miningOperation.js?v=fresh-20260919-1538-9d02b382";
import { generateSurveyContractDefinition, generateSurveyJobBoardDefinitions } from "./systems/surveyContracts.js?v=fresh-20260919-1538-9d02b382";
import { createEncounterDirector } from "./systems/encounterDirector.js?v=fresh-20260919-1538-9d02b382";
import { createPortalTrophy, getHostileLootCount, rollHostileLoot } from "./systems/hostileLoot.js?v=fresh-20260919-1538-9d02b382";
import { awardGateBountyToPatrol } from "./systems/gateBounty.js?v=fresh-20260919-1538-9d02b382";
import { createThreadwyrmField } from "./systems/threadwyrmField.js?v=fresh-20260919-1538-9d02b382";
import { recordVisitedZone } from "./systems/legalRecords.js?v=fresh-20260919-1538-9d02b382";
import { getSectorDesignation } from "./systems/sectorCodes.js?v=fresh-20260919-1538-9d02b382";
import { sampleEnvironment, getFlowAngle } from "./systems/worldHazards.js?v=fresh-20260919-1538-9d02b382";
import { inspectPublicIdentity } from "./systems/authorityInspections.js?v=fresh-20260919-1538-9d02b382";
import { getRegistryEntityIdForSite, getRegistrySubject, hasRegistryStatus, rememberRegistrySubject } from "./systems/entityRegistry.js?v=fresh-20260919-1538-9d02b382";
import { createCommercialCraftPublicIdentity, createControlledShipPublicIdentity, createNpcShipPublicIdentity } from "./systems/publicIdentity.js?v=fresh-20260919-1538-9d02b382";
import { getZoneProfile, WORLD_ZONES, getZoneInfluence } from "./systems/worldZones.js?v=fresh-20260919-1538-9d02b382";
import { getRegionProfile } from "./systems/worldRegions.js?v=fresh-20260919-1538-9d02b382";
import { createClaimField } from "./systems/claimField.js?v=fresh-20260919-1538-9d02b382";
import { getContractGrantedClaimIds, getPlotRestriction } from "./systems/operatingRights.js?v=fresh-20260919-1538-9d02b382";
import { getNearbyWorldSite, getNearestWorldSite, isInSiteRange } from "./systems/worldSites.js?v=fresh-20260919-1538-9d02b382";
import { createGameState } from "./state/gameState.js?v=fresh-20260919-1538-9d02b382";
import { canSpendCredits, debitCredits, depositCredits, getCredits, spendCredits } from "./systems/accounts.js?v=fresh-20260919-1538-9d02b382";
import { PLAYER_ATTRIBUTED_CAUSES } from "./systems/eventLedger.js?v=fresh-20260919-1538-9d02b382";
import { getResourceColor, getResourceShape, resourceTypesMatch } from "./systems/resourceDefinitions.js?v=fresh-20260919-1538-9d02b382";
import { terminateDestroyedActor } from "./systems/actorLifecycle.js?v=fresh-20260919-1538-9d02b382";
...
// tentacles and nothing more.
const BLOOM_BELL_RADIUS = 17;
// How closely the nose has to be pointed at the bell. cos(50°) ≈ 0.64 — wide
// enough to feel fair at speed, tight enough that a graze is not a kill.
const BLOOM_STRIKE_ALIGNMENT = 0.64;
// Below this the ship is loitering, not running anything down.
const BLOOM_STRIKE_MIN_SPEED = 46;
// ── Inside a greatbloom ─────────────────────────────────────────────────────
// The wall is the clock. Touch it and you are hurt and shoved back toward the
// middle, so a player who stops flying is ground down without ever being
// killed outright by one mistake.
const GREATBLOOM_WALL_DAMAGE = 7;
// Seconds between wall bites. Long enough to recover from a scrape, short
// enough that hugging the wall is fatal.
const GREATBLOOM_WALL_COOLDOWN = 0.55;
// How hard the wall throws the ship back inward.
const GREATBLOOM_WALL_SHOVE = 210;
...
// Defenses review their perimeter on a cadence even when they find nothing.
// Without an idle cadence, every hub searched the entire streamed asteroid
// field every animation frame until a target happened to enter range.
const HUB_DEFENSE_REVIEW_SECONDS = 0.16;
...
// Where the slipway stands relative to its hub, and how it paces its work.
// Far enough to the side that it never crosses the hub body or its approach
// markings — it was drawn across the top of Yard Exchange and read as part of
// the station rather than as a separate place that builds things.
const SHIPYARD_OFFSET_X = -215;
const SHIPYARD_OFFSET_Y = 0;
// How long a launch stays lit after a hull is actually sold.
const SHIPYARD_LAUNCH_MS = 6000;
// An idle yard is building stock, not stopped. One speculative hull per cycle.
const SHIPYARD_IDLE_CYCLE_MS = 15000;

// Where a hub parts factories sit. To the right of the body, opposite the
// slipway, in a row that grows as a hub commissions more.
const FACTORY_FIRST_X = 150;
const FACTORY_SPACING = 74;
const FACTORY_Y = 58;
const FACTORY_RADIUS = 18;
...
const GRAZER_PREDATION_INTERVAL_SECONDS = 1.2;
const GRAZER_PREDATION_BUDGET = 12;
...
export class Game {
  constructor(
    ...
    this.ship = new Ship(0, 0, state.components.engine, state.ship, state.components.hull);
    ...
    this.worldSites = getRuntimeWorldSites(this.state);
    this.patrolOperations = ensurePatrolOperations(this.state);
    this.transportCorridors = createTransportCorridors({ destinations: this.worldSites, connections: getRuntimeWorldConnections(this.state) });
    ...
    this.commissionHauler = ({ id, name, homeSiteId, launchSiteId = null, seed, carrierInstitutionId }) => {
      const hubs = this.worldSites.filter((site) => site.type === "hub");
      const home = hubs.find((site) => site.id === homeSiteId) ?? hubs[0];
      const launch = hubs.find((site) => site.id === launchSiteId) ?? home;
      const destination = launch.id === home.id ? hubs.find((site) => site.id !== launch.id) : home;
      if (!home || !launch || !destination) return null;
      ...
      const ship = createRouteShip(id, name, [launch, destination], seed ?? 9, laneOffset, operator.name, home.id, palette, publicIdentity);
      if (launchSiteId) {
        const ways = facilityOffset("shipyard", 0);
        ship.position.x = launch.position.x + ways.x;
        ship.position.y = launch.position.y + ways.y + laneOffset * 0.22;
        ship.dockedSiteId = launch.id;
      }
  ...
  update(deltaSeconds) {
    ...
    this.updateBloomStrikes(activeLifeforms);
    this.updateGreatbloomHold(activeLifeforms, deltaSeconds);
  ...
  firePatrolWeapon(patrol, target, targetDistance) {
    ...
    if (!target.body.isAlive) {
      ...
      const request = patrol.protectionRequestId
        ? this.state.protectionPlanning?.requests?.[patrol.protectionRequestId] : null;
      const patrolBeneficiaryId = patrol.protectionRequestId
        ? (patrol.protectionInternal ? request?.issuerInstitutionId : request?.providerInstitutionId)
        : patrol.site?.id;
  ...
  updateDebugReadout() {
    ...
    this.onDebugChange({
      ...
      geology: this.chunkManager.getGeologySnapshot(),
  ...
  updateHostileHits() {
    ...
    this.bullets.forEach((bullet) => {
      ...
      const struckEye = this.hitGreatbloomEye(bullet);
      if (struckEye && !hitHostiles.has(struckEye)) {
        bullet.destroy();
        struckEye.health -= 1;
        if (struckEye.health <= 0) {
          hitHostiles.add(struckEye);
          this.burstGreatbloom(struckEye, bullet.velocity);
        } else {
          const eye = struckEye.getEyePosition();
          this.createHunterBurst(
            { position: eye, radius: GREATBLOOM_EYE_RADIUS, velocity: struckEye.velocity },
            bullet.velocity,
  ...
  clearIncursionPortal(portal, { rewardCredits = true, cause = "weapon", site = null, protectionRequestId = null, patrolHull = null, patrolBeneficiaryId = null } = {}) {
    ...
    // A patrol that made the kill collects its own token and sends proof by
    // telemetry. Internal watches credit their hub; contract patrols credit the
    // controlling security firm (including a singleton operator's own account).
    // Everybody else still leaves a physical bearer token in the field.
    let patrolAward = null;
    const patrolKill = cause.includes("patrol-defense") && patrolBeneficiaryId;
    if (reward > 0) {
      const trophy = createPortalTrophy({ waveCount: portal.waveCount, tradeValue: reward });
      if (patrolKill) {
        const beneficiary = this.state.logistics?.institutions?.[patrolBeneficiaryId];
        patrolAward = awardGateBountyToPatrol(this.state, {
          unit: trophy, beneficiaryId: patrolBeneficiaryId,
          account: beneficiary?.accounts?.operating, siteId: site?.id ?? null,
        });
      }
      if (!patrolAward?.redeemed) {
        this.pickups.push(new ResourcePickup({
          x: portal.position.x,
          y: portal.position.y,
          type: trophy.type,
    ...
    this.state.ledger.recordEvent("incursion.portalDestroyed", {
      ...
      reward: 0,
      trophyValue: reward,
      bountyBeneficiaryId: patrolAward?.beneficiaryId ?? null,
      bountyPaid: patrolAward?.total ?? 0,
      cause,
      siteId: site?.id ?? null,
      siteName: site?.name ?? null,
      x: Math.round(portal.position.x),
  ...
  updateLifeformContacts(activeLifeforms) {
    ...
    const onGlass = Math.max(24, Math.min(this.canvas.width, this.canvas.height) / 2 - VIEWPORT_SCOPE_MARGIN);
    const contactChecks = [
      {
        type: "rockmoss",
  ...
  updateAmbientLife(deltaSeconds) {
    ...
    const condensedApexes = condenseDistantApexGrazers(this.lifeforms.filter((lifeform) => lifeform.type === "grazer"), {
      shipPosition: this.ship.position,
      minimumDistance: AMBIENT_LIFE_DESPAWN_RADIUS,
    });
    if (condensedApexes.length > 0) {
      this.state.ledger.recordEvent("life.distantApexCondensed", {
        removed: condensedApexes.length,
        localities: new Set(condensedApexes.map((entry) => entry.localityKey)).size,
      }, { visible: false });
    }
  ...
  shouldDespawnAmbientLife(lifeform) {
    ...
    // Ordinary ripe grazers now condense into old giants while a field is being
    // observed. Only those rare apex animals remain persistent after the player
    // leaves; preserving every ripe grazer is what allowed a long run to retain
    // several thousand fully simulated creatures.
    if (lifeform.type === "grazer" && (lifeform.fullness ?? 0) >= GRAZING_DEFAULTS.apexPersistAt) {
      return false;
    }
  ...
  updateHubDefenses(deltaSeconds) {
    ...
    // This is a review interval, not merely a post-shot cooldown. Reset it
    // before searching so an empty perimeter cannot trigger another full-world
    // search on the next animation frame.
    this.hubDefenseCooldown = HUB_DEFENSE_REVIEW_SECONDS;
    ...
    this.worldSites
      ...
      .forEach((site) => {
        ...
        // Find the nearest obstruction in one pass. The previous
        // filter/map/filter/sort chain allocated and sorted a full copy of the
        // multi-thousand-body asteroid field once per hub per review.
        let target = null;
        let nearestDistance = Infinity;
        for (const asteroid of this.asteroids) {
          if (hitAsteroids.has(asteroid)) continue;
          const asteroidDistance = distance(asteroid.position, site.position);
          if (asteroidDistance - asteroid.radius > clearanceRadius || asteroidDistance >= nearestDistance) continue;
          target = asteroid;
          nearestDistance = asteroidDistance;
        }
  ...
  updateNpcShips(activeAsteroids, deltaSeconds) {
    const navigationObstacles = [
      ...activeAsteroids,
      ...infrastructureNavigationObstacles(this.state, this.worldSites),
    ];
    // Physical travel state belongs to logistics. SPRC's `availableForWork`
    // becomes false as soon as a repair is booked, including while the craft is
    // still flying to Scrap Porch. Mirroring that flag directly onto the ship
    // used to freeze an inbound hauler wherever the order happened to open.
    ...
    this.npcShips.forEach((ship) => {
      ...
      ship.update(deltaSeconds, {
        ...
        navigationObstacles: localNpcShips.includes(ship) ? navigationObstacles : [],
      ...
      ship.consumeEvents().forEach((event) => {
        ...
        const navigationMessages = {
          ...
          "npc.subspaceEntered": `${ship.name} slipped beneath normal space for the long crossing.`,
          "npc.subspaceExited": `${ship.name} returned to normal space for its approach.`,
        };
      ...
      const hitAsteroid = !ship.isSubspaceActive && localNpcShips.includes(ship) && activeAsteroids.find((asteroid) =>
  ...
  breakAsteroid(asteroid, impactVelocity, audioContext = {}) {
    ...
    // The chunk that supplied this rock must also own every descendant.  If it
    // does not, abandoned fragments escape chunk unloading forever while the
    // deterministic parent is generated again on the next visit.  A final
    // coloured break means material physically entered the pickup economy;
    // plain rubble merely needs time to re-accrete.
    this.chunkManager?.recordBreak(asteroid, fragments, {
      resourceExtracted: asteroid.tier <= 1 && asteroid.color !== WHITE_ASTEROID_COLOR,
    });
  ...
  updateGrazing(deltaSeconds, activeLifeforms = this.lifeforms, activeAsteroids = this.asteroids) {
    ...
    const biomass = enforceEcologicalBiomassBudget(grazers, { shipPosition: this.ship?.position ?? null });
    if (biomass.culled.length > 0) {
      this.state.ledger.recordEvent("life.biomassBudgetEnforced", {
        removed: biomass.culled.length,
        localities: biomass.localities,
      }, { visible: false });
    }

    this.grazerPredationCooldown = Math.max(0, (this.grazerPredationCooldown ?? 0) - deltaSeconds);
    if (this.grazerPredationCooldown <= 0) {
      this.grazerPredationCooldown = GRAZER_PREDATION_INTERVAL_SECONDS;
      const predations = condenseGrazerPopulation(grazers, {
        shipPosition: this.ship?.position ?? null,
        maxPredations: GRAZER_PREDATION_BUDGET,
      });
      predations.forEach(({ predator, prey }) => {
        this.state.ledger.recordEvent("life.grazerPredation", {
          predatorFullness: Number((predator.fullness ?? 0).toFixed(2)),
          preyFullness: Number((prey.fullness ?? 0).toFixed(2)),
          x: Math.round(predator.position.x),
          y: Math.round(predator.position.y),
        }, { visible: false });
      });
    }
  ...
  // Blooms drift; the player lines one up and runs it through. The reward for
  // aiming is the crystal in its bell, so contact alone must not be enough or
  // the whole thing collapses into "fly around touching lights".
  updateBloomStrikes(activeLifeforms) {
    const speed = Math.hypot(this.ship.velocity.x, this.ship.velocity.y);
    if (speed < BLOOM_STRIKE_MIN_SPEED) {
      return;
    }

    const heading = { x: Math.cos(this.ship.angle), y: Math.sin(this.ship.angle) };
    // The tip of the hull, not its centre. This is the part that does the work.
    const nose = {
      x: this.ship.position.x + heading.x * SHIP_COLLISION_RADIUS,
      y: this.ship.position.y + heading.y * SHIP_COLLISION_RADIUS,
    };

    activeLifeforms.forEach((lifeform) => {
      if (lifeform.type !== "bloom" || !lifeform.isAlive) {
        return;
      }

      if (distance(nose, lifeform.position) > BLOOM_BELL_RADIUS) {
        return;
      }

      const reachX = lifeform.position.x - this.ship.position.x;
      const reachY = lifeform.position.y - this.ship.position.y;
      const reach = Math.hypot(reachX, reachY) || 1;
      const alignment = (heading.x * reachX + heading.y * reachY) / reach;
      if (alignment < BLOOM_STRIKE_ALIGNMENT) {
        return;
      }

      this.burstBloom(lifeform);
    });
  }
  ...
  burstBloom(bloom) {
    ...
    // The same burst every other kill in the world uses, in the bloom's own
    // rose. It already alternates white with the colour it is given, which is
    // exactly the pink-and-white puff this wants.
    this.createHunterBurst(bloom, this.ship.velocity, { count: 26, sparkEvery: 2, color: "#ff9ed6" });

    // Its four tentacles come off whole and drift, rather than shattering with
    // the rest of it. They are the part of a bloom you can see moving, so they
    // are the part worth keeping for a moment after the animal is gone.
    for (let index = 0; index < 4; index += 1) {
      const spread = Math.PI + (index - 1.5) * 0.34;
      const drift = 34 + Math.random() * 46;
      this.particles.push({
        type: "tendril",
        position: {
          x: bloom.position.x + Math.cos(spread) * 10,
          y: bloom.position.y + Math.sin(spread) * 10,
        },
        velocity: {
          x: bloom.velocity.x * 0.5 + Math.cos(spread) * drift + this.ship.velocity.x * 0.05,
          y: bloom.velocity.y * 0.5 + Math.sin(spread) * drift + this.ship.velocity.y * 0.05,
        },
        color: "rgba(255, 158, 214, 0.75)",
    ...
    const crystals = rollBloomHarvest();
    for (let index = 0; index < crystals; index += 1) {
      const angle = Math.random() * Math.PI * 2;
      const speed = 60 + Math.random() * 90;
      this.pickups.push(new ResourcePickup({
        x: bloom.position.x + Math.cos(angle) * 6,
        y: bloom.position.y + Math.sin(angle) * 6,
        type: BLOOM_HARVEST_RESOURCE,
        velocity: {
          x: bloom.velocity.x * 0.3 + Math.cos(angle) * speed + this.ship.velocity.x * 0.06,
          y: bloom.velocity.y * 0.3 + Math.sin(angle) * speed + this.ship.velocity.y * 0.06,
        },
      }));
    }

    // Something has been feeding on this field too, and it notices the tally.
    const rammed = this.state.ledger.incrementStat("life.bloomsRammed", 1);
    if (rammed % BLOOM_KILLS_PER_GREATBLOOM === 0) {
      this.summonGreatbloom();
    }
    ...
    this.state.ledger.recordEvent(
      ...
      { type: "bloom", crystals },
      crystals > 0
        ? { visible: true, message: `Bloom struck — ${crystals} crystal matrix recovered.` }
        : { visible: true, message: "Bloom struck — its bell was empty." },
    );
  }

  // One at a time. A second one rising while the player is already inside the
  // first would not be a harder fight, it would be an unsurvivable one.
  summonGreatbloom() {
    if (this.lifeforms.some((lifeform) => lifeform.type === "greatbloom" && lifeform.isAlive)) {
      return;
    }
    ...
    const beast = createSurfacingGreatbloom({
      ...
      asteroids: this.asteroids,
      camera: this.camera,
      view: { width: this.canvas.width, height: this.canvas.height },
      seed: this.state.ledger.getStat("life.bloomsRammed", 0),
    });
    this.lifeforms.push(beast);

    this.state.ledger.recordEvent(
      "life.greatbloomSurfacing",
      { fromRock: beast.cameFromRock === true },
      {
        visible: true,
        message: beast.cameFromRock
          ? "Something large is coming out from under a rock."
          : "Something large is rising out of the deep.",
      },
    );
  }

  // Being eaten, and staying alive in there.
  //
  // A greatbloom that reaches the ship seals it in and keeps drifting. From
  // then on the only thing that matters is the distance from the player to the
  // bell wall: ride the animal and you are fine, fall behind and the far wall
  // arrives.
  updateGreatbloomHold(activeLifeforms, deltaSeconds) {
    this.greatbloomWallCooldown = Math.max(0, (this.greatbloomWallCooldown ?? 0) - deltaSeconds);

    activeLifeforms.forEach((lifeform) => {
      if (lifeform.type !== "greatbloom" || !lifeform.isAlive) {
        return;
      }

      const reach = distance(this.ship.position, lifeform.position);
      const shipRadius = this.getShipCollisionRadius();

      // The bite. Nothing is taken off the player for being swallowed — the
      // trap IS the damage, and hitting them on the way in would read as
      // punishment for something they could not yet have avoided.
      // It got what it came for. The ship is wreckage now, so the animal lets
      // go and sinks back down the way it came up — leaving the hull floating
      // for whoever the player calls.
      if (this.shipDestroyed && lifeform.isHolding) {
        lifeform.isHolding = false;
        lifeform.isDeparting = true;
        this.state.ledger.recordEvent(
          "life.greatbloomDeparting",
          {},
          { visible: true, message: "The greatbloom lets go and sinks back into the deep." },
        );
        return;
      }

      // Still climbing, or on its way out: it can be seen and shot at, but it
      // is not solid and it cannot take anyone. Being swallowed by something
      // the size of a dinner plate would make nonsense of the lunge.
      if (lifeform.isSurfaced === false || lifeform.isDeparting) {
        return;
      }

      if (!lifeform.isHolding) {
        if (reach < lifeform.radius - shipRadius) {
          lifeform.isHolding = true;
          this.state.ledger.recordEvent(
            "life.engulfed",
            { type: "greatbloom" },
            { visible: true, message: "A greatbloom has you. Stay off the wall and put shots in the eye." },
          );
        }
        return;
      }

      // Sealed in. Everything below is the wall.
      const clearance = lifeform.radius - shipRadius;
      if (reach <= clearance) {
        return;
      }

      // Push the ship back inside no matter what — the bell does not let go,
      // so escaping by out-accelerating the wall must not be possible.
      const outX = (this.ship.position.x - lifeform.position.x) / (reach || 1);
      const outY = (this.ship.position.y - lifeform.position.y) / (reach || 1);
      this.ship.position.x = lifeform.position.x + outX * clearance;
      this.ship.position.y = lifeform.position.y + outY * clearance;
      this.ship.velocity.x -= outX * GREATBLOOM_WALL_SHOVE;
      this.ship.velocity.y -= outY * GREATBLOOM_WALL_SHOVE;

      // Hurt on a cadence rather than every frame, or a single brush against
      // the wall would empty the hull in well under a second.
      if (this.greatbloomWallCooldown > 0) {
        return;
      }

      this.greatbloomWallCooldown = GREATBLOOM_WALL_COOLDOWN;
      this.damageHull(GREATBLOOM_WALL_DAMAGE);
      this.createHunterBurst(
        { position: { x: this.ship.position.x, y: this.ship.position.y }, radius: 12, velocity: { x: 0, y: 0 } },
        this.ship.velocity,
        { count: 10, sparkEvery: 2, color: "#ff6fc4" },
      );
    });
  }

  // Only the eye can be hurt. Shooting the wall does nothing, which is what
  // makes tracking the eye around the rim the second half of the job.
  hitGreatbloomEye(bullet) {
    return this.lifeforms.find((lifeform) => {
      if (lifeform.type !== "greatbloom" || !lifeform.isAlive) return false;
      const eye = lifeform.getEyePosition();
      return circlesOverlap(bullet.position, bullet.radius, eye, GREATBLOOM_EYE_RADIUS);
    }) ?? null;
  }

  burstGreatbloom(greatbloom, impactVelocity) {
    greatbloom.isAlive = false;
    greatbloom.isHolding = false;

    this.createHunterBurst(greatbloom, impactVelocity ?? { x: 0, y: 0 }, {
      count: 64, sparkEvery: 2, color: "#ff6fc4",
    });

    for (let index = 0; index < 8; index += 1) {
      const spread = Math.random() * Math.PI * 2;
      const drift = 70 + Math.random() * 110;
      this.particles.push({
        type: "tendril",
        position: {
          x: greatbloom.position.x + Math.cos(spread) * greatbloom.radius * 0.7,
          y: greatbloom.position.y + Math.sin(spread) * greatbloom.radius * 0.7,
        },
        velocity: { x: Math.cos(spread) * drift, y: Math.sin(spread) * drift },
        color: "rgba(255, 111, 196, 0.8)",
    ...
    // A grown one is carrying a season's worth. This is the payout for a fight
    // rather than for a well-aimed nudge, so it is not rolled on the small
    // bloom's table.
    const crystals = 6 + Math.floor(Math.random() * 5);
    for (let index = 0; index < crystals; index += 1) {
      const angle = Math.random() * Math.PI * 2;
      const speed = 70 + Math.random() * 140;
      this.pickups.push(new ResourcePickup({
        x: greatbloom.position.x + Math.cos(angle) * 14,
        y: greatbloom.position.y + Math.sin(angle) * 14,
        type: BLOOM_HARVEST_RESOURCE,
    ...
    this.state.ledger.recordEvent(
      "life.harvested",
      { type: "greatbloom", crystals },
      { visible: true, message: `Greatbloom killed — ${crystals} crystal matrix recovered.` },
    );
  }
  ...
  draw() {
    ...
    const circularViewport = this.state.ui?.viewportLayout !== "fullscreen-background";

    clearScreen(this.context, this.canvas);
    if (circularViewport) {
      // The canvas spans the whole cockpit, but the world exists only behind
      // the round glass. Clearing the outside makes physical side machinery
      // visible beneath it while the opaque circle hides every pipe end.
      const { centerX, centerY, radius } = this.getCircularViewportGeometry();
      this.context.clearRect(0, 0, this.canvas.width, this.canvas.height);
      this.context.save();
      this.context.beginPath();
      this.context.arc(centerX, centerY, radius, 0, Math.PI * 2);
      this.context.clip();
      this.context.fillStyle = "#07080c";
    ...
    // A hull painted in its operator's colours keeps them; everything else
    ...
    if (circularViewport) {
      this.drawCircularViewportFrame();
    }
  }

  getCircularViewportGeometry() {
    const margin = VIEWPORT_SCOPE_MARGIN;
    return {
      centerX: this.canvas.width / 2,
      centerY: this.canvas.height / 2,
      radius: Math.max(24, Math.min(this.canvas.width, this.canvas.height) / 2 - margin),
    };
  }

  drawCircularViewportFrame() {
    const { centerX, centerY, radius } = this.getCircularViewportGeometry();
    const phosphor = this.state.ui?.cockpit?.phosphorColor ?? "#7dffe0";
    this.context.save();
    this.context.strokeStyle = phosphor;
  ...
  drawWorldSites(camera = this.camera, canvas = this.canvas) {
    this.worldSites.forEach((site) => {
      ...
      this.context.fill();
      this.context.stroke();
      if (site.tier === "capital") {
        // A hexagon rather than the rotated square every other hub wears, and an
        // inner ring inside the body. Decoration with a job: the capital should
        // be identifiable from further away than you can read its label.
        this.context.beginPath();
        this.context.arc(0, 0, site.radius * 0.66, 0, Math.PI * 2);
        this.context.stroke();
        this.context.beginPath();
        for (let corner = 0; corner < 6; corner += 1) {
          const angle = (Math.PI / 3) * corner - Math.PI / 2;
          const x = Math.cos(angle) * site.radius * 0.42;
          const y = Math.sin(angle) * site.radius * 0.42;
          if (corner === 0) this.context.moveTo(x, y);
      ...
      if (site.tier === "capital") {
        this.context.save();
        this.context.setLineDash([14, 10]);
        this.context.strokeStyle = isNearby ? "rgba(158, 232, 255, 0.22)" : "rgba(115, 210, 255, 0.09)";
        this.context.beginPath();
        this.context.arc(screenX, screenY, site.interactionRadius * 0.72, 0, Math.PI * 2);
        this.context.stroke();
        this.context.restore();
      }
      ...
      if (site.id === "yard-exchange") {
        this.drawShipyardFixtures(screenX, screenY);
      }
      this.drawHubFactories(site, screenX, screenY);
      this.drawHubSupplyLines(site, screenX, screenY);
    });
  }
  ...
  drawShipyardFixtures(siteScreenX, siteScreenY) {
    ...
    this.context.save();
    const berth = facilityOffset("shipyard", 0);
    this.context.translate(siteScreenX + berth.x, siteScreenY + berth.y);
    this.context.font = "10px ui-monospace, monospace";
    this.context.textAlign = "center";
    this.context.lineWidth = 2;
  ...
  // Every parts factory in the world, drawn where it stands.
  //
  // The Maw has always been visible at Scrap Porch and everything else that
  // turns ore into parts was invisible — the Yard Plate Works, the Ledge Machine
  // Works, the Ore Light-Alloy Works, and any factory a hub commissions later.
  // Nothing here is keyed to a hub id: a factory built at runtime appears
  // without new drawing code, because a hidden industry is one the player cannot
  // reason about.
  drawHubFactories(site, siteScreenX, siteScreenY) {
    const factories = Object.values(this.state.industrial?.factories ?? {})
      .filter((factory) => this.factorySiteId(factory) === site.id);
    ...
    factories.forEach((factory, index) => {
      const spot = facilityOffset("parts-factory", index);
      const x = spot.x;
      const y = spot.y;
      const run = factory.activeRun ?? null;
      const running = Boolean(run);
      const span = run ? Math.max(1, run.completesAt - run.startedAt) : 1;
      const progress = run ? Math.min(1, Math.max(0, (nowMs - run.startedAt) / span)) : 0;
      const pulse = (nowMs % 1200) / 1200;

      // The body, lit while it is working.
      this.context.strokeStyle = running ? "#ffb85c" : "rgba(255, 184, 92, 0.45)";
      this.context.fillStyle = running
        ? `rgba(255, 184, 92, ${0.1 + pulse * 0.1})`
        : "rgba(255, 184, 92, 0.05)";
      this.context.lineWidth = 2;
      this.context.beginPath();
      this.context.arc(x, y, FACTORY_RADIUS, 0, Math.PI * 2);
      this.context.fill();
      this.context.stroke();

      // How far through the run it is, as an arc around the body. This is the
      // sausage being made: a real fraction of a real recipe, not a spinner.
      if (running) {
        this.context.strokeStyle = "rgba(255, 240, 200, 0.95)";
        this.context.lineWidth = 3;
        this.context.beginPath();
        this.context.arc(x, y, FACTORY_RADIUS + 5, -Math.PI / 2, -Math.PI / 2 + progress * Math.PI * 2);
        this.context.stroke();
        this.context.lineWidth = 2;
      }

      // The heart, beating while it works.
      this.context.strokeStyle = running ? "#ffd8a0" : "rgba(255, 184, 92, 0.35)";
      this.context.beginPath();
      this.context.arc(x, y, 5 + (running ? pulse * 4 : 0), 0, Math.PI * 2);
      this.context.stroke();

      this.context.fillStyle = "rgba(255, 230, 166, 0.85)";
      this.context.fillText(this.factoryShortName(factory), x, y + FACTORY_RADIUS + 14);
      if (running) {
        this.context.fillStyle = "rgba(255, 246, 214, 0.9)";
        this.context.fillText(String(run.output ?? "").replaceAll("-", " ").toUpperCase(), x, y + FACTORY_RADIUS + 25);
      }
    });
  ...
  factorySiteId(factory) {
    return this.state.logistics?.institutions?.[factory.institutionId]?.siteId ?? factory.institutionId;
  }

  // "Yard Plate Works" is too long to sit under a 20px circle; the last word is
  // the part that distinguishes one from another.
  factoryShortName(factory) {
    const words = String(factory.name ?? factory.id).split(" ");
    return words.slice(-2).join(" ").toUpperCase();
  }

  // Material moving between the parts of a station.
  //
  // The same language the haulers already use to unload: a dashed tether, and
  // the goods themselves travelling along it. Ore goes from the hub warehouse
  // out to a works that is running, and finished parts go from the works to the
  // ways while a hull is being laid. Nothing here invents activity — a line only
  // exists while the work at its far end is actually happening.
  drawHubSupplyLines(site, siteScreenX, siteScreenY) {
    const factories = Object.values(this.state.industrial?.factories ?? {})
      .filter((factory) => this.factorySiteId(factory) === site.id);
    if (factories.length === 0) return;

    const yard = Object.values(this.state.logistics?.institutions ?? {})
      .find((institution) => institution?.archetypeId === "shipyard" && institution.siteId === site.id);
    const buildingHull = Boolean(yard?.build);
    const berth = facilityOffset("shipyard", 0);
    const nowMs = Date.now();
    ...
    factories.forEach((factory, index) => {
      ...
      // Ore, hub to works, while it is converting.
      if (run) {
        const inputs = this.factoryRunInputs(factory, run);
        inputs.forEach((resourceId, slot) => {
          this.drawTransferLine({ x: 0, y: 0 }, spot, resourceId,
            ((nowMs / 900) + slot * 0.4 + index * 0.27) % 1);
        });
      }

      // Parts, works to ways, while a hull is on the ways.
      if (buildingHull) {
        this.drawTransferLine(spot, berth, "hull-plate",
          ((nowMs / 1100) + index * 0.33) % 1);
      }
    });
  ...
  factoryRunInputs(factory, run) {
    const recipe = (factory.recipes ?? []).find((entry) => entry.output === run.output);
    return Object.keys(recipe?.inputs ?? {});
  }

  drawTransferLine(from, to, resourceId, phase) {
    this.context.save();
    this.context.strokeStyle = "rgba(158, 232, 255, 0.2)";
    this.context.lineWidth = 1;
    ...
    this.context.fillStyle = getResourceColor(resourceId);
  ...
  drawParticles(camera = this.camera) {
    this.particles.forEach((particle) => {
      ...
      } else if (particle.type === "tendril") {
        this.context.rotate(particle.angle + (particle.maxLife - particle.life) * particle.spin);
        this.context.strokeStyle = particle.color;
        this.context.lineWidth = 1.5;
        this.context.beginPath();
        this.context.moveTo(-particle.size / 2, 0);
        this.context.quadraticCurveTo(0, particle.size * 0.45, particle.size / 2, 0);
        this.context.stroke();
  ...
  getCollectorRadius() {
    // The tractor occupies about 30% of the circular viewport's radius rather
    // than nearly matching the portal itself.
    const viewportRadius = Math.max(24, Math.min(this.canvas.width, this.canvas.height) / 2 - VIEWPORT_SCOPE_MARGIN);
    const base = viewportRadius * 0.3;
    const collector = this.state.components.collector;
    if (!collector?.installed) {
      return base;
    }
