import { Bullet } from "./entities/Bullet.js?v=fresh-20260717-2226-d0a062a";
import { breakAsteroid, WHITE_ASTEROID_COLOR } from "./entities/Asteroid.js?v=fresh-20260717-2226-d0a062a";
import { createResourcePickupsFromAsteroid, ResourcePickup } from "./entities/ResourcePickup.js?v=fresh-20260717-2226-d0a062a";
import { Ship } from "./entities/Ship.js?v=fresh-20260717-2226-d0a062a";
import { createAsteroidChunks } from "./systems/asteroidField.js?v=fresh-20260717-2226-d0a062a";
import { createCamera } from "./systems/camera.js";
import { createInput } from "./systems/input.js?v=fresh-20260717-2226-d0a062a";
import { createHunterNearShip, createHunterRespawn, createLifeField } from "./systems/lifeField.js?v=fresh-20260717-2226-d0a062a";
import { createNpcRouteShips } from "./systems/npcRoutes.js?v=fresh-20260717-2226-d0a062a";
import { clearScreen, drawGrid, drawVector, isVisible } from "./systems/rendering.js?v=fresh-20260717-2226-d0a062a";
import { createResourceField } from "./systems/resourceField.js?v=fresh-20260717-2226-d0a062a";
import { createScanner } from "./systems/scanner.js?v=fresh-20260717-2226-d0a062a";
import { createDriftMouthField } from "./systems/driftMouthField.js?v=fresh-20260717-2226-d0a062a";
import { createIncursionField } from "./systems/incursionField.js?v=fresh-20260717-2226-d0a062a";
import { createThreadwyrmField } from "./systems/threadwyrmField.js?v=fresh-20260717-2226-d0a062a";
import { recordVisitedZone } from "./systems/legalRecords.js?v=fresh-20260717-2226-d0a062a";
import { inspectPublicIdentity } from "./systems/authorityInspections.js?v=fresh-20260717-2226-d0a062a";
import { getRegistryEntityIdForSite, getRegistrySubject, rememberRegistrySubject } from "./systems/entityRegistry.js?v=fresh-20260717-2226-d0a062a";
import { createControlledShipPublicIdentity, createNpcShipPublicIdentity } from "./systems/publicIdentity.js?v=fresh-20260717-2226-d0a062a";
import { getZoneProfile, WORLD_ZONES, getZoneInfluence } from "./systems/worldZones.js?v=fresh-20260717-2226-d0a062a";
import { createClaimField } from "./systems/claimField.js?v=fresh-20260717-2226-d0a062a";
import { getNearbyWorldSite, getNearestWorldSite, getWorldSites, isInSiteRange } from "./systems/worldSites.js?v=fresh-20260717-2226-d0a062a";
import { createGameState } from "./state/gameState.js?v=fresh-20260717-2226-d0a062a";
import { canSpendCredits, debitCredits, depositCredits, getCredits, spendCredits } from "./systems/accounts.js?v=fresh-20260717-2226-d0a062a";
