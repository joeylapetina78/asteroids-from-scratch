import { Bullet } from "./entities/Bullet.js?v=fresh-20260802-0005-942466e";
import { breakAsteroid, WHITE_ASTEROID_COLOR } from "./entities/Asteroid.js?v=fresh-20260802-0005-942466e";
import { createResourcePickupsFromAsteroid, ResourcePickup } from "./entities/ResourcePickup.js?v=fresh-20260802-0005-942466e";
import { drawResourceShape } from "./entities/ResourcePickup.js?v=fresh-20260802-0005-942466e";
import { Ship } from "./entities/Ship.js?v=fresh-20260802-0005-942466e";
import { ShipWreck } from "./entities/ShipWreck.js?v=fresh-20260802-0005-942466e";
import { completeWreckSalvage, registerOwnedWreck } from "./systems/wreckRegistry.js?v=fresh-20260802-0005-942466e";
import { createAsteroidChunks } from "./systems/asteroidField.js?v=fresh-20260802-0005-942466e";
import { applyPanelPatch, HULL_REPAIR_DELAY_SECONDS, HULL_REPAIR_RATE, accumulatePanelWear, ensurePanelCondition, panelStageIndex, repairPanelCondition } from "./systems/panelMaintenance.js?v=fresh-20260802-0005-942466e";
import { ENGINE_CONDITION_CONFIG, computeEngineWearDelta, getEngineStageEffects } from "./systems/engineCondition.js?v=fresh-20260802-0005-942466e";
import { createCamera } from "./systems/camera.js?v=fresh-20260802-0005-942466e";
import { createInput } from "./systems/input.js?v=fresh-20260802-0005-942466e";
import { createAmbientLifeBatch, createHunterNearShip, createHunterRespawn, createLifeField, seedChunkRockmoss } from "./systems/lifeField.js?v=fresh-20260802-0005-942466e";
import { ROCKMOSS_STRAINS } from "./systems/rockmossStrains.js?v=fresh-20260802-0005-942466e";
import { HAULER_PALETTES, RELIEF_HAULER_PALETTE, createNpcRouteShips, createRouteShip } from "./systems/npcRoutes.js?v=fresh-20260802-0005-942466e";
import { clearScreen, drawGrid, drawVector, isVisible } from "./systems/rendering.js?v=fresh-20260802-0005-942466e";
import { createResourceField } from "./systems/resourceField.js?v=fresh-20260802-0005-942466e";
import { createScanner } from "./systems/scanner.js?v=fresh-20260802-0005-942466e";
import { createDriftMouthField } from "./systems/driftMouthField.js?v=fresh-20260802-0005-942466e";
import { createIncursionField } from "./systems/incursionField.js?v=fresh-20260802-0005-942466e";
import { ensurePatrolOperations, getAvailablePatrolCraft, markPatrolCraftStatus } from "./systems/patrolOperations.js?v=fresh-20260802-0005-942466e";
...
import { injectBountyJobs } from "./systems/bountyContracts.js?v=fresh-20260802-0005-942466e";
import { injectCargoRuns } from "./systems/cargoContracts.js?v=fresh-20260802-0005-942466e";
import { getStandingFreightJobsForSite } from "./systems/logistics.js?v=fresh-20260802-0005-942466e";
import { FIRST_REACH_TRANSPORT_CONNECTIONS } from "./content/transportation/firstReachNetwork.js?v=fresh-20260802-0005-942466e";
import { applyCorridorMaintenance, createTransportCorridors, getCorridorClearance } from "./systems/transportCorridors.js?v=fresh-20260802-0005-942466e";
import { getStandingMiningJobsForSite } from "./systems/miningOperation.js?v=fresh-20260802-0005-942466e";
import { generateSurveyContractDefinition, generateSurveyJobBoardDefinitions } from "./systems/surveyContracts.js?v=fresh-20260802-0005-942466e";
import { createEncounterDirector } from "./systems/encounterDirector.js?v=fresh-20260802-0005-942466e";
import { createPortalTrophy, getHostileLootCount, rollHostileLoot } from "./systems/hostileLoot.js?v=fresh-20260802-0005-942466e";
import { createThreadwyrmField } from "./systems/threadwyrmField.js?v=fresh-20260802-0005-942466e";
import { recordVisitedZone } from "./systems/legalRecords.js?v=fresh-20260802-0005-942466e";
import { getSectorDesignation } from "./systems/sectorCodes.js?v=fresh-20260802-0005-942466e";
import { sampleEnvironment, getFlowAngle } from "./systems/worldHazards.js?v=fresh-20260802-0005-942466e";
import { inspectPublicIdentity } from "./systems/authorityInspections.js?v=fresh-20260802-0005-942466e";
import { getRegistryEntityIdForSite, getRegistrySubject, rememberRegistrySubject } from "./systems/entityRegistry.js?v=fresh-20260802-0005-942466e";
import { createCommercialCraftPublicIdentity, createControlledShipPublicIdentity, createNpcShipPublicIdentity } from "./systems/publicIdentity.js?v=fresh-20260802-0005-942466e";
import { getZoneProfile, WORLD_ZONES, getZoneInfluence } from "./systems/worldZones.js?v=fresh-20260802-0005-942466e";
import { getRegionProfile } from "./systems/worldRegions.js?v=fresh-20260802-0005-942466e";
import { createClaimField } from "./systems/claimField.js?v=fresh-20260802-0005-942466e";
import { getNearbyWorldSite, getNearestWorldSite, getWorldSites, isInSiteRange } from "./systems/worldSites.js?v=fresh-20260802-0005-942466e";
import { createGameState } from "./state/gameState.js?v=fresh-20260802-0005-942466e";
import { canSpendCredits, debitCredits, depositCredits, getCredits, spendCredits } from "./systems/accounts.js?v=fresh-20260802-0005-942466e";
