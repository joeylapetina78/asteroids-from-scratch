...
The prototype now runs a nine-hub institutional economy. Each settlement is an enduring institutional NPC whose controlled assets publish its capabilities; named representatives, operational craft and populations sit beneath that actor rather than replacing it. Populations create demand; hubs plan projects, produce, discover competing suppliers, commission capacity, buy physical material, hire freight, and expose prices and blockers. Operational people can earn bespoke status through recorded careers, and successful municipal facilities can become independent businesses. Authored and procedurally generated hubs pass through the same seed-to-actor pipeline. The player increasingly accepts the same procedural mining, freight, bounty, salvage, protection and territorial-rights records. See [docs/HANDOFF.md](docs/HANDOFF.md), [docs/institutional-npcs-and-assets.md](docs/institutional-npcs-and-assets.md), and [docs/level-of-detail.md](docs/level-of-detail.md).

Distant hubs can now hand their quiescent economic loop to a measured regional-flow model and restore detailed operation around the exact same institutional actor when approached. Active orders, shipments, extraction, industry and protection work block aggregation rather than being discarded. This is the first conservative abstraction boundary; physical operational populations and conserved aggregate-to-aggregate clearing remain future work.
...
The immediate milestone is long-run validation of distant aggregation: watch which FAR hubs become aggregate, which obligations keep busy hubs detailed, how modeled stock and cash drift over time, and whether approach restores cleanly. The next engineering work is first-class aggregation observability, stale-rate re-synchronization, conserved checkpointing for persistently active hubs, and eventual aggregation/restoration of operational craft populations while bespoke actors remain preserved anchors.

The next world-growth track is connecting institutional projects to procedural surveying and settlement founding through the existing common seed pipeline. Territory should gain upkeep, benefits, negotiation, transfer and conflict through shared assets and authority. Only after that baseline is observable should hub asymmetry be reintroduced one capability or efficiency at a time.

Merchant ownership and brokerage, used parts, criminality, piracy, debt failure and higher authority rights remain larger progression described in [docs/HANDOFF.md](docs/HANDOFF.md).
